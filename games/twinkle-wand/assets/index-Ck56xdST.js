...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ms(e,t,n){return new Ja({name:`SphericalGaussianBlur`,defines:{SAMPLES:_s,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ns(){return new Ja({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ps(){return new Ja({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fs(),fragmentShader:`
	...
	`}var Is=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=$c(i,i.VERTEX_SHADER,y),S=$c(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=al(i,x,`vertex`),n=al(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,du=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ui(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Ja({vertexShader:lu,fragmentShader:uu,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new $r(new Pa(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},fu=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,f=null,p=null,m=null,h=typeof XRWebGLBinding<`u`,_=new du,v={},y=t.getContextAttributes(),b=null,S=null,C=[],w=[],T=new U,k=null,A=null,j=new Mo;j.viewport=new Kt;let ee=new Mo;ee.viewport=new Kt;let te=[j,ee],M=new zo,N=null,P=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function ne(e){let t=w.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function re(){r.removeEventListener(`select`,ne),r.removeEventListener(`selectstart`,ne),r.removeEventListener(`selectend`,ne),r.removeEventListener(`squeeze`,ne),r.removeEventListener(`squeezestart`,ne),r.removeEventListener(`squeezeend`,ne),r.removeEventListener(`end`,re),r.removeEventListener(`inputsourceschange`,ie);for(let e=0;e<C.length;e++){let t=w[e];t!==null&&(w[e]=null,C[e].disconnect(t))}N=null,P=null,_.reset();for(let e in v)delete v[e];if(e.setRenderTarget(b),p=null,f=null,u=null,r=null,S=null,de.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(T.width,T.height,!1),A!==null){let e=A.camera;e.fov=A.fov,e.zoom=A.zoom,e.updateProjectionMatrix(),A=null}n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&B(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&B(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,ne),r.addEventListener(`selectstart`,ne),r.addEventListener(`selectend`,ne),r.addEventListener(`squeeze`,ne),r.addEventListener(`squeezestart`,ne),r.addEventListener(`squeezeend`,ne),r.addEventListener(`end`,re),r.addEventListener(`inputsourceschange`,ie),y.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;y.depth&&(o=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=y.stencil?O:D,a=y.stencil?x:g);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),f=u.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Jt(f.textureWidth,f.textureHeight,{format:E,type:d,depthTexture:new ci(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Jt(p.framebufferWidth,p.framebufferHeight,{format:E,type:d,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1,storeMultisampledDepthBuffer:p.ignoreDepthValues===!1,storeMultisampledStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),de.setContext(r),de.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ie(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=w.indexOf(n);r>=0&&(w[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=w.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=w.length){w.push(n),r=e;break}else if(w[e]===null){w[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let ae=new W,oe=new W;function se(e,t,n){ae.setFromMatrixPosition(t.matrixWorld),oe.setFromMatrixPosition(n.matrixWorld);let r=ae.distanceTo(oe),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),M.near=ee.near=j.near=t,M.far=ee.far=j.far=n,(N!==M.near||P!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),N=M.near,P=M.far),M.layers.mask=e.layers.mask|6,j.layers.mask=M.layers.mask&-5,ee.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;ce(M,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?se(M,j,ee):M.projectionMatrix.copy(j.projectionMatrix),A===null&&e.isPerspectiveCamera&&(A={camera:e,fov:e.fov,zoom:e.zoom}),F(e,M,i)};function F(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)},this.getCameraTexture=function(e){return v[e]};let le=null;function ue(t,i){if(l=i.getViewerPose(c||a),m=i,l!==null){let t=l.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=u.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=te[n];o===void 0&&(o=new Mo,o.layers.enable(n),o.viewport=new Kt,te[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new ui,v[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=w[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}le&&le(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),m=null}let de=new is;de.setAnimationLoop(ue),this.setAnimationLoop=function(e){le=e},this.dispose=function(){}}},pu=new Zt,mu=new G;mu.set(-1,0,0,0,1,0,0,0,1);function hu(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Wa(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(pu.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(mu),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.retroreflectivity>0&&(e.retroreflectivity.value=t.retroreflectivity),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function gu(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return V(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?B(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):B(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var _u=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),vu=null;function yu(){return vu===null&&(vu=new ni(_u,16,16,j,v),vu.name=`DFG_LUT`,vu.minFilter=c,vu.magFilter=c,vu.wrapS=r,vu.wrapT=r,vu.generateMipmaps=!1,vu.needsUpdate=!0),vu}var bu=class{constructor(e={}){let{canvas:t=Je(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:p=!1,outputBufferType:h=d}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);_=n.getContextAttributes().alpha}else _=a;let S=h,C=new Set([te,ee,A]),w=new Set([d,g,m,x,y,b]),T=new Uint32Array(4),E=new Int32Array(4),D=new W,O=null,k=null,j=[],M=[],N=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let P=this,ne=!1,re=null,ie=null,ae=null,oe=null;this._outputColorSpace=Re;let se=0,ce=0,F=null,le=-1,ue=null,de=new Kt,fe=new Kt,pe=null,me=new K(0),he=0,ge=t.width,_e=t.height,ve=1,ye=null,be=null,xe=new Kt(0,0,ge,_e),Se=new Kt(0,0,ge,_e),Ce=!1,we=new oi,Te=!1,Ee=!1,De=new Zt,Oe=new W,ke=new Kt,Ae={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},je=!1;function Me(){return F===null?ve:1}let I=n;function Ne(e,n){return t.getContext(e,n)}let Pe,Fe,L,Ie,R,z,Le,ze,Be,Ve,He,Ue,Ge,Ke,qe,Ye,Ze,Qe,et,tt,nt,rt,it;try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:f};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r186`),t.addEventListener(`webglcontextlost`,H,!1),t.addEventListener(`webglcontextrestored`,st,!1),t.addEventListener(`webglcontextcreationerror`,ct,!1),I===null){let t=`webgl2`;if(I=Ne(t,e),I===null)throw Ne(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}at()}catch(e){throw t.removeEventListener(`webglcontextlost`,H,!1),t.removeEventListener(`webglcontextrestored`,st,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),V(`WebGLRenderer: `+e.message),e}function at(){Pe=new Rs(I),Pe.init(),nt=new cu(I,Pe),Fe=new ps(I,Pe,e,nt),L=new ou(I,Pe),Fe.reversedDepthBuffer&&p&&L.buffers.depth.setReversed(!0),ie=I.createFramebuffer(),ae=I.createFramebuffer(),oe=I.createFramebuffer(),Ie=new Vs(I),R=new Bl,z=new su(I,Pe,L,R,Fe,nt,Ie),Le=new Ls(P),ze=new as(I),rt=new ds(I,ze),Be=new zs(I,ze,Ie,rt),Ve=new Us(I,Be,ze,rt,Ie),Qe=new Hs(I,Fe,z),qe=new ms(R),He=new zl(P,Le,Pe,Fe,rt,qe),Ue=new hu(P,R),Ge=new Wl,Ke=new Zl(Pe),Ze=new us(P,Le,L,Ve,_,s),Ye=new au(P,Ve,Fe),it=new gu(I,Ie,Fe,L),et=new fs(I,Pe,Ie),tt=new Bs(I,Pe,Ie),Ie.programs=He.programs,P.capabilities=Fe,P.extensions=Pe,P.properties=R,P.renderLists=Ge,P.shadowMap=Ye,P.state=L,P.info=Ie}S!==1009&&(N=new Gs(S,t.width,t.height,o,r,i));let ot=new fu(P,I);this.xr=ot,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){let e=Pe.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Pe.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ve},this.setPixelRatio=function(e){e!==void 0&&(ve=e,this.setSize(ge,_e,!1))},this.getSize=function(e){return e.set(ge,_e)},this.setSize=function(e,n,r=!0){if(ot.isPresenting){B(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ge=e,_e=n,t.width=Math.floor(e*ve),t.height=Math.floor(n*ve),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),N!==null&&N.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ge*ve,_e*ve).floor()},this.setDrawingBufferSize=function(e,n,r){ge=e,_e=n,ve=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){V(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){B(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}N.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(de)},this.getViewport=function(e){return e.copy(xe)},this.setViewport=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),L.viewport(de.copy(xe).multiplyScalar(ve).round())},this.getScissor=function(e){return e.copy(Se)},this.setScissor=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),L.scissor(fe.copy(Se).multiplyScalar(ve).round())},this.getScissorTest=function(){return Ce},this.setScissorTest=function(e){L.setScissorTest(Ce=e)},this.setOpaqueSort=function(e){ye=e},this.setTransparentSort=function(e){be=e},this.getClearColor=function(e){return e.copy(Ze.getClearColor())},this.setClearColor=function(){Ze.setClearColor(...arguments)},this.getClearAlpha=function(){return Ze.getClearAlpha()},this.setClearAlpha=function(){Ze.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(F!==null){let t=F.texture.format;e=C.has(t)}if(e){let e=F.texture.type,t=w.has(e),n=Ze.getClearColor(),r=Ze.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,I.clearBufferuiv(I.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,I.clearBufferiv(I.COLOR,0,E))}else r|=I.COLOR_BUFFER_BIT}t&&(r|=I.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&I.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),re=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,H,!1),t.removeEventListener(`webglcontextrestored`,st,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),Ze.dispose(),Ge.dispose(),Ke.dispose(),R.dispose(),Le.dispose(),Ve.dispose(),rt.dispose(),it.dispose(),He.dispose(),ot.dispose(),ot.removeEventListener(`sessionstart`,ht),ot.removeEventListener(`sessionend`,gt),_t.stop()};function H(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),ne=!0}function st(){Xe(`WebGLRenderer: Context Restored.`),ne=!1;let e=Ie.autoReset,t=Ye.enabled,n=Ye.autoUpdate,r=Ye.needsUpdate,i=Ye.type;at(),Ie.autoReset=e,Ye.enabled=t,Ye.autoUpdate=n,Ye.needsUpdate=r,Ye.type=i}function ct(e){V(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function lt(e){let t=e.target;t.removeEventListener(`dispose`,lt),ut(t)}function ut(e){dt(e),R.remove(e)}function dt(e){let t=R.get(e).programs;t!==void 0&&(t.forEach(function(e){He.releaseProgram(e)}),e.isShaderMaterial&&He.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Ae);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Dt(e,t,n,r,i);L.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Be.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;rt.setup(i,r,s,n,c);let h,g=et;if(c!==null&&(h=ze.get(c),g=tt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(L.setLineWidth(r.wireframeLinewidth*Me()),g.setMode(I.LINES)):g.setMode(I.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),L.setLineWidth(e*Me()),i.isLineSegments?g.setMode(I.LINES):i.isLineLoop?g.setMode(I.LINE_LOOP):g.setMode(I.LINE_STRIP)}else i.isPoints?g.setMode(I.POINTS):i.isSprite&&g.setMode(I.TRIANGLES);if(i.isBatchedMesh){if(Pe.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?ze.get(c).bytesPerElement:1,o=R.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(I,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ft(e,t,n,r){re!==null&&e.isNodeMaterial&&re.setObject(r,e),Te===!0&&qe.setState(e,n,!1),e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Ct(e,t,r),e.side=0,e.needsUpdate=!0,Ct(e,t,r),e.side=2):Ct(e,t,r)}this.compile=function(e,t,n=null){n===null&&(n=e),re!==null&&re.renderStart(e,t,n),k=Ke.get(n),k.init(t),M.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights(),re!==null&&re.updateLights(k.state.lightsArray),Ee=this.localClippingEnabled,Te=qe.init(this.clippingPlanes,Ee),Te===!0&&qe.setGlobalState(this.clippingPlanes,t),re!==null&&Ye.render(k.state.shadowsArray,n,t);let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let i=e.material;if(i){if(Array.isArray(i))for(let a=0;a<i.length;a++){let o=i[a];ft(o,n,t,e),r.add(o)}else ft(i,n,t,e),r.add(i)}}),k=M.pop(),re!==null&&re.renderEnd(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){let t=R.get(e).currentProgram;(t===void 0||t.isReady())&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Pe.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let pt=null;function mt(e){pt&&pt(e)}function ht(){_t.stop()}function gt(){_t.start()}let _t=new is;_t.setAnimationLoop(mt),typeof self<`u`&&_t.setContext(self),this.setAnimationLoop=function(e){pt=e,ot.setAnimationLoop(e),e===null?_t.stop():_t.start()},ot.addEventListener(`sessionstart`,ht),ot.addEventListener(`sessionend`,gt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){V(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ne===!0)return;re!==null&&re.renderStart(e,t);let n=ot.enabled===!0&&ot.isPresenting===!0,r=N!==null&&(F===null||n)&&N.begin(P,F);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(N===null||N.isCompositing()===!1)&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(t),t=ot.getCamera()),e.isScene===!0&&e.onBeforeRender(P,e,t,F),k=Ke.get(e,M.length),k.init(t),k.state.textureUnits=z.getTextureUnits(),M.push(k),De.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),we.setFromProjectionMatrix(De,We,t.reversedDepth),Ee=this.localClippingEnabled,Te=qe.init(this.clippingPlanes,Ee),O=Ge.get(e,j.length),O.init(),j.push(O),ot.enabled===!0&&ot.isPresenting===!0){let e=P.xr.getDepthSensingMesh();e!==null&&vt(e,t,-1/0,P.sortObjects)}vt(e,t,0,P.sortObjects),O.finish(),re!==null&&re.updateLights(k.state.lightsArray),P.sortObjects===!0&&O.sort(ye,be),je=ot.enabled===!1||ot.isPresenting===!1||ot.hasDepthSensing()===!1,je&&Ze.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Te===!0&&qe.beginShadows();let i=k.state.shadowsArray;if(Ye.render(i,e,t),Te===!0&&qe.endShadows(),(r&&N.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];bt(n,r,e,a)}je&&Ze.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];yt(O,e,n,n.viewport)}}else r.length>0&&bt(n,r,e,t),je&&Ze.render(e),yt(O,e,t)}F!==null&&ce===0&&(z.updateMultisampleRenderTarget(F),z.updateRenderTargetMipmap(F)),r&&N.end(P),e.isScene===!0&&e.onAfterRender(P,e,t),rt.resetDefaultState(),le=-1,ue=null,M.pop(),M.length>0?(k=M[M.length-1],z.setTextureUnits(k.state.textureUnits),Te===!0&&qe.setGlobalState(P.clippingPlanes,k.state.camera)):k=null,j.pop(),O=j.length>0?j[j.length-1]:null,re!==null&&re.renderEnd()};function vt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||e.intersectsFrustum(we)){r&&ke.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De);let i=Ve.update(e),a=e.material;a.visible&&O.push(e,i,a,n,ke.z,null,t)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||e.intersectsFrustum(we))){let i=Ve.update(e),a=e.material;if(r&&(e.boundingSphere===void 0?(i.boundingSphere===null&&i.computeBoundingSphere(),ke.copy(i.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),ke.copy(e.boundingSphere.center)),ke.applyMatrix4(e.matrixWorld).applyMatrix4(De)),Array.isArray(a)){let r=i.groups;for(let o=0,s=r.length;o<s;o++){let s=r[o],c=a[s.materialIndex];c&&c.visible&&O.push(e,i,c,n,ke.z,s,t)}}else a.visible&&O.push(e,i,a,n,ke.z,null,t)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)vt(i[e],t,n,r)}function yt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Te===!0&&qe.setGlobalState(P.clippingPlanes,n),r&&L.viewport(de.copy(r)),i.length>0&&xt(i,t,n),a.length>0&&xt(a,t,n),o.length>0&&xt(o,t,n),L.buffers.depth.setTest(!0),L.buffers.depth.setMask(!0),L.buffers.color.setMask(!0),L.setPolygonOffset(!1)}function bt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Pe.has(`EXT_color_buffer_half_float`)||Pe.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Jt(1,1,{generateMipmaps:!0,type:e?v:d,minFilter:u,samples:Math.max(4,Fe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:Ft.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||de;a.setSize(o.z*P.transmissionResolutionScale,o.w*P.transmissionResolutionScale);let s=P.getRenderTarget(),c=P.getActiveCubeFace(),l=P.getActiveMipmapLevel();P.setRenderTarget(a),P.getClearColor(me),he=P.getClearAlpha(),he<1&&P.setClearColor(16777215,.5),P.clear(),je&&Ze.render(n);let f=P.toneMapping;P.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Te===!0&&qe.setGlobalState(P.clippingPlanes,r),xt(e,n,r),z.updateMultisampleRenderTarget(a),z.updateRenderTargetMipmap(a),Pe.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,St(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(z.updateMultisampleRenderTarget(a),z.updateRenderTargetMipmap(a))}P.setRenderTarget(s,c,l),P.setClearColor(me,he),p!==void 0&&(r.viewport=p),P.toneMapping=f}function xt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&St(o,t,n,s,l,c)}}function St(e,t,n,r,i,a){re!==null&&i.isNodeMaterial&&re.setObject(e,i),e.onBeforeRender(P,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(P,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,P.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,P.renderBufferDirect(n,t,r,i,e,a),i.side=2):P.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(P,t,n,r,i,a)}function Ct(e,t,n){t.isScene!==!0&&(t=Ae);let r=R.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=He.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=He.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Le.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,lt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Tt(e,s),d}else s.uniforms=He.getUniforms(e),re!==null&&e.isNodeMaterial&&re.build(e,n,s),e.onBeforeCompile(s,P),d=He.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=qe.uniform),Tt(e,s),r.needsLights=Ot(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.sunLights.value=i.state.sun,f.sunLightShadows.value=i.state.sunShadow,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.sunShadowMatrix.value=i.state.sunShadowMatrix,f.sunShadowCascade.value=i.state.sunShadowCascade,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function wt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Qc.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Tt(e,t){let n=R.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Et(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Dt(e,t,n,r,i){t.isScene!==!0&&(t=Ae),z.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=F===null?P.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Ft.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Le.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(h=P.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=R.get(r),y=k.state.lights;if(Te===!0&&(Ee===!0||e!==ue)){let t=e===ue&&r.id===le;qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i._colorsTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i._colorsTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==qe.numPlanes||v.numIntersection!==qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Ct(r,t,i),re&&r.isNodeMaterial&&re.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(L.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==le&&(le=r.id,C=!0),v.needsLights){let e=Et(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||ue!==e){L.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(I,`projectionMatrix`,e.projectionMatrix),T.setValue(I,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(I,Oe.setFromMatrixPosition(e.matrixWorld)),Fe.logarithmicDepthBuffer&&T.setValue(I,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(I,`isOrthographic`,e.isOrthographicCamera===!0),ue!==e&&(ue=e,C=!0,w=!0)}if(v.needsLights&&(y.state.sunShadowMap.length>0&&T.setValue(I,`sunShadowMap`,y.state.sunShadowMap,z),y.state.directionalShadowMap.length>0&&T.setValue(I,`directionalShadowMap`,y.state.directionalShadowMap,z),y.state.spotShadowMap.length>0&&T.setValue(I,`spotShadowMap`,y.state.spotShadowMap,z),y.state.pointShadowMap.length>0&&T.setValue(I,`pointShadowMap`,y.state.pointShadowMap,z)),i.isSkinnedMesh){T.setOptional(I,i,`bindMatrix`),T.setOptional(I,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(I,`boneTexture`,e.boneTexture,z))}i.isBatchedMesh&&(T.setOptional(I,i,`batchingTexture`),T.setValue(I,`batchingTexture`,i._matricesTexture,z),T.setOptional(I,i,`batchingIdTexture`),T.setValue(I,`batchingIdTexture`,i._indirectTexture,z),T.setOptional(I,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(I,`batchingColorTexture`,i._colorsTexture,z));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Qe.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(I,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=yu()),C){if(T.setValue(I,`toneMappingExposure`,P.toneMappingExposure),v.needsLights&&U(E,w),a&&r.fog===!0&&Ue.refreshFogUniforms(E,a),Ue.refreshMaterialUniforms(E,r,ve,_e,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Qc.upload(I,wt(v),E,z)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Qc.upload(I,wt(v),E,z),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(I,`center`,i.center),T.setValue(I,`modelViewMatrix`,i.modelViewMatrix),T.setValue(I,`normalMatrix`,i.normalMatrix),T.setValue(I,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];it.update(n,x),it.bind(n,x)}}return x}function U(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.sunLights.needsUpdate=t,e.sunLightShadows.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Ot(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return se},this.getActiveMipmapLevel=function(){return ce},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(e,t,n){let r=R.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),R.get(e.texture).__webglTexture=t,R.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=R.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){F=e,se=t,ce=n;let r=null,i=!1,a=!1;if(e){let o=R.get(e);if(o.__useDefaultFramebuffer!==void 0){L.bindFramebuffer(I.FRAMEBUFFER,o.__webglFramebuffer),de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest,L.viewport(de),L.scissor(fe),L.setScissorTest(pe),le=-1;return}if(o.__webglFramebuffer===void 0)z.setupRenderTarget(e);else if(o.__hasExternalTextures)z.rebindTextures(e,R.get(e.texture).__webglTexture,R.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&R.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);z.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=R.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&z.useMultisampledRTT(e)===!1?R.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,de.copy(e.viewport),fe.copy(e.scissor),pe=e.scissorTest}else de.copy(xe).multiplyScalar(ve).floor(),fe.copy(Se).multiplyScalar(ve).floor(),pe=Ce;if(n!==0&&(r=ie),L.bindFramebuffer(I.FRAMEBUFFER,r)&&L.drawBuffers(e,r),L.viewport(de),L.scissor(fe),L.setScissorTest(pe),i){let r=R.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=R.get(e.textures[t]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=R.get(e.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,t.__webglTexture,n)}le=-1};function kt(e){let t=R.get(e);return(t.__readFormat!==e.format||t.__readType!==e.type)&&(t.__readFormat=e.format,t.__readType=e.type,t.__formatReadable=Fe.textureFormatReadable(e.format),t.__typeReadable=Fe.textureTypeReadable(e.type)),t}this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=R.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){L.bindFramebuffer(I.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s);let u=kt(o);if(u.__formatReadable===!1){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(u.__typeReadable===!1){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&I.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=F===null?null:R.get(F).__webglFramebuffer;L.bindFramebuffer(I.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=R.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){L.bindFramebuffer(I.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;e.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+s);let d=kt(o);if(d.__formatReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(d.__typeReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let f=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,f),I.bufferData(I.PIXEL_PACK_BUFFER,a.byteLength,I.STREAM_READ),I.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0),I.bindBuffer(I.PIXEL_PACK_BUFFER,null);let p=F===null?null:R.get(F).__webglFramebuffer;L.bindFramebuffer(I.FRAMEBUFFER,p);let m=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await $e(I,m,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,f),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,a),I.bindBuffer(I.PIXEL_PACK_BUFFER,null),I.deleteBuffer(f),I.deleteSync(m),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;z.setTexture2D(e,0),I.copyTexSubImage2D(I.TEXTURE_2D,n,0,0,o,s,i,a),L.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(z.setTexture3D(t,0),v=I.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(z.setTexture2DArray(t,0),v=I.TEXTURE_2D_ARRAY):(z.setTexture2D(t,0),v=I.TEXTURE_2D),L.activeTexture(I.TEXTURE0),L.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,t.flipY),L.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),L.pixelStorei(I.UNPACK_ALIGNMENT,t.unpackAlignment);let y=L.getParameter(I.UNPACK_ROW_LENGTH),b=L.getParameter(I.UNPACK_IMAGE_HEIGHT),x=L.getParameter(I.UNPACK_SKIP_PIXELS),S=L.getParameter(I.UNPACK_SKIP_ROWS),C=L.getParameter(I.UNPACK_SKIP_IMAGES);L.pixelStorei(I.UNPACK_ROW_LENGTH,h.width),L.pixelStorei(I.UNPACK_IMAGE_HEIGHT,h.height),L.pixelStorei(I.UNPACK_SKIP_PIXELS,l),L.pixelStorei(I.UNPACK_SKIP_ROWS,u),L.pixelStorei(I.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=R.get(e),r=R.get(t),h=R.get(n.__renderTarget),g=R.get(r.__renderTarget);L.bindFramebuffer(I.READ_FRAMEBUFFER,h.__webglFramebuffer),L.bindFramebuffer(I.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,R.get(e).__webglTexture,i,d+n),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,R.get(t).__webglTexture,a,m+n)),I.blitFramebuffer(l,u,o,s,f,p,o,s,I.DEPTH_BUFFER_BIT,I.NEAREST);L.bindFramebuffer(I.READ_FRAMEBUFFER,null),L.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||R.has(e)){let n=R.get(e),r=R.get(t);L.bindFramebuffer(I.READ_FRAMEBUFFER,ae),L.bindFramebuffer(I.DRAW_FRAMEBUFFER,oe);for(let e=0;e<c;e++)w?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,n.__webglTexture,i),T?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,r.__webglTexture,a),i===0?T?I.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):I.copyTexSubImage2D(v,a,f,p,l,u,o,s):I.blitFramebuffer(l,u,o,s,f,p,o,s,I.COLOR_BUFFER_BIT,I.NEAREST);L.bindFramebuffer(I.READ_FRAMEBUFFER,null),L.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?I.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):I.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):I.texSubImage2D(I.TEXTURE_2D,a,f,p,o,s,g,_,h);L.pixelStorei(I.UNPACK_ROW_LENGTH,y),L.pixelStorei(I.UNPACK_IMAGE_HEIGHT,b),L.pixelStorei(I.UNPACK_SKIP_PIXELS,x),L.pixelStorei(I.UNPACK_SKIP_ROWS,S),L.pixelStorei(I.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&I.generateMipmap(v),L.unbindTexture()},this.initRenderTarget=function(e){R.get(e).__webglFramebuffer===void 0&&z.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?z.setTextureCube(e,0):e.isData3DTexture?z.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?z.setTexture2DArray(e,0):z.setTexture2D(e,0),L.unbindTexture()},this.resetState=function(){se=0,ce=0,F=null,L.reset(),rt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Ft._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ft._getUnpackColorSpace()}},xu=`v0.3-dev`,Su={up:[`KeyW`,`ArrowUp`],down:[`KeyS`,`ArrowDown`],left:[`KeyA`,`ArrowLeft`],right:[`KeyD`,`ArrowRight`],attack:[`Space`,`KeyJ`],dash:[`ShiftLeft`,`ShiftRight`,`KeyK`],restart:[`KeyR`],start:[`Space`,`Enter`]},Cu={fov:38,distance:21,pitchDeg:45,yawDeg:45,followSharpness:6,lookHeight:.6},wu={hemi:1.25,sun:1.7},Tu={radius:13,bushCount:40,tuftCount:60,seed:7},Y={radius:.45,centerHeight:.6,moveSpeed:5.5,accel:18,turnSharpness:20,maxHearts:5,hurtInvuln:1.4,hurtStun:.25,hurtKnockback:7,downTime:1.3,inputBuffer:.25,comboWindow:.4,swipeLinger:.14,dash:{speed:14,duration:.24,iframes:.32,cooldown:.4},combo:[{damage:10,range:2,arcDeg:140,windup:.07,active:.08,recovery:.2,cancelAfter:.06,lunge:.6,knockback:5,hitstop:.05,shake:.12,big:!1},{damage:12,range:2.1,arcDeg:160,windup:.07,active:.08,recovery:.22,cancelAfter:.06,lunge:.7,knockback:6,hitstop:.06,shake:.15,big:!1},{damage:24,range:2.6,arcDeg:360,windup:.14,active:.14,recovery:.38,cancelAfter:.3,lunge:.4,knockback:11,hitstop:.11,shake:.32,big:!0}]},Eu={hp:30,radius:.55,spawnTime:.45,spawnStagger:.25,hopSpeed:3.2,hopDuration:.38,hopInterval:.6,hopHeight:.55,attackRange:1.7,windup:.9,lungeSpeed:7.5,lungeDuration:.22,rest:1.1,hitstun:.4,damage:1,knockbackScale:1,knockbackFriction:7,popTime:.35},Du={list:[{count:5},{count:5}],spawnRadius:9,firstDelay:.8,betweenDelay:1.8,bossDelay:2,quizDelay:1,afterQuizDelay:.6},Ou={name:`Grumpy Cloud`,hp:360,radius:1.5,floatHeight:1.9,enterHeight:12,enterTime:1.6,moveSpeed:2.2,keepDistance:4.5,firstAttackDelay:1.8,cooldown:2.6,cooldownAngry:2,angryAt:.5,castTime:.7,knockbackScale:.15,knockbackFriction:6,popTime:1.4,pattern:[`rain`,`thunder`,`rain`],rain:{count:4,countAngry:6,spread:3.2,radius:1.1,telegraph:1.7,stagger:.18,damage:1},thunder:{radius:2.1,telegraph:2.2,damage:1,extraAngry:2,extraOffset:3.2,extraDelay:.5}},ku={storageKey:`twinkle-wand.progress.v1`,shieldBonusHp:60,rechargeHearts:1,starsPerCorrect:1,praiseTime:1.3,praise:[`Great job!`,`Super!`,`Awesome!`,`Nice work!`,`Wow!`],reviewDelay:2.4},Au={dir:`assets/sprites/mochi/`,frameSize:256,size:180,sizeNarrow:112,sheets:{thinking:{file:`mochi-thinking-v01.png`,frames:8,fps:8},happy:{file:`mochi-happy-v02.png`,frames:8,fps:12},oops:{file:`mochi-oops-v02.png`,frames:8,fps:10}},happyLoops:2,oopsLoops:1,lines:{thinking:`Let's think!`,happy:`You got it!`,oops:`Oops! Try again.`,reveal:`Let's look together.`,review:`You did great!`}},ju={fallTime:.35,fallHeight:9,splashTime:.25,hitRadiusBonus:.15},Mu={flashTime:.1,hitSquashKick:5,attackStretchKick:-3,dashKick:-2,hurtSquashKick:6,shakeMax:.45,shakeDecay:2.2,hurtShake:.35,hurtHitstop:.08,enemyPopShake:.12,bossPopShake:.6,damageNumber:{life:.75,rise:2.2},particles:{hit:6,pop:14,bossPop:40,swipe:5},confettiCount:160},X={sky:12576511,ground:11857107,groundEdge:9427128,bushes:[16763101,13481215,10670847,16773544],tufts:[10216386,13956580],shadow:5208680,hemiSky:16777215,hemiGround:11857107,sun:16774890,heroRobe:12167167,heroRobeTrim:16773544,heroSkin:16770001,heroHair:16752580,heroEye:4865877,heroBlush:16748465,wandStick:16775136,wandStar:16767053,jelly:[16752335,10410239,13215743,16763274,10481861],jellyFace:4865877,shine:16777215,boss:13223398,bossShade:11183572,bossFace:4865877,bossCheek:16752580,telegraphRing:6967200,telegraphFill:10190800,raindrop:8177919,thunder:16770906,flowerPetals:[16748465,16765286,12822271,9425919,16777215],flowerCenter:16769126,flowerStem:6276239,swipe:16774048,particleStar:[16769126,16775106,16777215,16757721],particleHeart:[16743080,16757703],particleRain:[8177919,12576511],particleDust:[16777215,15138804],shield:12167167,particleShield:[12167167,14932991,16777215]},Nu={text:`#5b4a6b`,panel:`rgba(255, 255, 255, 0.88)`,accent:`#9d8cff`,heart:`#ff6f9f`,heartEmpty:`#eadcea`,bossBar:`#ff8fc1`,bossBarBg:`#ffe3ef`,keycap:`#ffffff`,keycapShadow:`#cdbdf2`,titleA:`#ff7aa8`,titleB:`#9d8cff`,overlay:`rgba(191, 230, 255, 0.55)`,star:`#ffc93c`,shield:`#b9a7ff`,choice:`#ffffff`,choiceHover:`#f3edff`,correct:`#8fe3b8`,wrong:`#ffc2d4`,hintBg:`#fff7d6`,damage:[`#ff6fa5`,`#ffa24d`,`#6fb8ff`,`#b07cff`],damageBig:`#ffb800`,confetti:[`#ff8fb1`,`#ffd166`,`#9ed8ff`,`#c3a6ff`,`#9ff0c5`,`#ffffff`]},Pu=(e,t,n)=>Math.max(t,Math.min(n,e)),Fu=(e,t,n)=>e+(t-e)*n,Iu=(e,t)=>1-Math.exp(-e*t),Lu=e=>e[Math.floor(Math.random()*e.length)];function Ru(e,t,n){let r=(t-e)%(Math.PI*2);return r>Math.PI&&(r-=Math.PI*2),r<-Math.PI&&(r+=Math.PI*2),e+r*n}function zu(e){return 1+2.70158*(e-1)**3+1.70158*(e-1)**2}var Bu=e=>1-(1-e)**3;function Vu(e,t){let n=Tu.radius-t,r=Math.hypot(e.x,e.z);r>n&&(e.x*=n/r,e.z*=n/r)}var Hu=class{constructor(e=180,t=12){this.k=e,this.d=t,this.x=0,this.v=0}kick(e){this.v+=e}update(e){return this.v+=(-this.k*this.x-this.d*this.v)*e,this.x+=this.v*e,this.x=Pu(this.x,-.6,.6),this.x}};function Uu(e){let t=e>>>0;return()=>(t=t*1664525+1013904223>>>0,t/4294967296)}var Wu=null;function Gu(){return Wu||(Wu=new ni(new Uint8Array([120,200,255]),3,1,k),Wu.minFilter=a,Wu.magFilter=a,Wu.needsUpdate=!0),Wu}function Z(e,t={}){return new Xa({color:e,gradientMap:Gu(),...t})}function Ku(e,t={}){return new Vr({color:e,...t})}function Q(e,t,n=0,r=0,i=0){let a=new $r(e,t);return a.position.set(n,r,i),a}var qu=(e,t=20)=>new Ra(e,t,Math.round(t*.75));function Ju(e=1,t=.45,n=5){let r=new Ki;for(let i=0;i<n*2;i++){let a=i%2?t:e,o=Math.PI/2+i*Math.PI/n,s=Math.cos(o)*a,c=Math.sin(o)*a;i===0?r.moveTo(s,c):r.lineTo(s,c)}return r.closePath(),r}function Yu(){return new Ia(Ju())}function Xu(){let e=new Ki;e.moveTo(5,5),e.bezierCurveTo(5,5,4,0,0,0),e.bezierCurveTo(-6,0,-6,7,-6,7),e.bezierCurveTo(-6,11,-3,15.4,5,19),e.bezierCurveTo(12,15.4,16,11,16,7),e.bezierCurveTo(16,7,16,0,10,0),e.bezierCurveTo(7,0,5,5,5,5);let t=new Ia(e);return t.translate(-5,-9.5,0),t.scale(.1,.1,.1),t.rotateZ(Math.PI),t}function Zu(e){let t=[];return e.traverse(e=>{e.material&&e.material.emissive&&(e.material.userData.baseEmissive=e.material.emissive.clone(),t.push(e.material))}),t}var Qu=new K(1,1,1);function $u(e,t){for(let n of e)n.emissive.copy(n.userData.baseEmissive).lerp(Qu,t)}function ed(e){let t=Q(new fi(e,28),Ku(X.shadow,{transparent:!0,opacity:.22,depthWrite:!1}),0,.02,0);return t.rotation.x=-Math.PI/2,t.renderOrder=1,t}function td(){let e=new En,t=Tu.radius,n=Q(new pi(t,t,.6,72),Z(X.ground),0,-.3,0),r=Q(new pi(t+.8,t+1.1,.7,72),Z(X.groundEdge),0,-.42,0);e.add(n,r);let i=Uu(Tu.seed),a=qu(.7,16);for(let n=0;n<Tu.bushCount;n++){let r=n/Tu.bushCount*Math.PI*2,o=Q(a,Z(X.bushes[n%X.bushes.length]),Math.cos(r)*(t+.4),.15,Math.sin(r)*(t+.4));o.scale.setScalar(.8+i()*.5),e.add(o)}let o=qu(.14,10);for(let n=0;n<Tu.tuftCount;n++){let r=i()*Math.PI*2,a=Math.sqrt(i())*(t-1.2),s=new En,c=X.tufts[n%X.tufts.length];s.add(Q(o,Z(c),0,.02,0),Q(o,Z(c),.15,0,.06),Q(o,Z(c),-.12,0,.1)),s.position.set(Math.cos(r)*a,0,Math.sin(r)*a),e.add(s)}return e}function nd(){let e=new En,t=Q(new pi(.24,.46,.62,24),Z(X.heroRobe),0,.31,0),n=Q(new za(.44,.05,8,28),Z(X.heroRobeTrim),0,.04,0);n.rotation.x=Math.PI/2;let r=Q(new za(.22,.05,8,24),Z(X.heroRobeTrim),0,.62,0);r.rotation.x=Math.PI/2;let i=Q(qu(.37,24),Z(X.heroSkin),0,.98,0),a=Q(new Ra(.39,24,16,0,Math.PI*2,0,Math.PI*.52),Z(X.heroHair),0,.99,-.02);a.rotation.x=-.45;let o=Q(qu(.17,16),Z(X.heroHair),-.37,1.18,-.06),s=Q(qu(.17,16),Z(X.heroHair),.37,1.18,-.06),c=qu(.055,12),l=Q(c,Z(X.heroEye),-.13,.95,.33),u=Q(c,Z(X.heroEye),.13,.95,.33);l.scale.set(1,1.35,.6),u.scale.set(1,1.35,.6);let d=qu(.018,8),f=Q(d,Ku(X.shine),-.115,.975,.365),p=Q(d,Ku(X.shine),.145,.975,.365),m=qu(.06,12),h=Q(m,Ku(X.heroBlush,{transparent:!0,opacity:.7}),-.23,.87,.28),g=Q(m,Ku(X.heroBlush,{transparent:!0,opacity:.7}),.23,.87,.28);h.scale.set(1.4,.7,.4),g.scale.set(1.4,.7,.4);let _=qu(.09,12),v=Q(_,Z(X.heroSkin),-.36,.42,.08),y=new En;y.position.set(.36,.42,.08);let b=Q(_,Z(X.heroSkin)),x=Q(new pi(.03,.03,.62,10),Z(X.wandStick),0,.28,0),S=new $r(new Aa(Ju(1,.48),{depth:.35,bevelEnabled:!0,bevelThickness:.15,bevelSize:.12,bevelSegments:2}),Z(X.wandStar,{emissive:6967808}));return S.geometry.center(),S.scale.setScalar(.15),S.position.set(0,.66,0),y.add(b,x,S),y.rotation.x=.35,e.add(t,n,r,i,a,o,s,l,u,f,p,h,g,v,y),{root:e,parts:{wandPivot:y,star:S,head:i}}}function rd(e){let t=new En,n=Q(qu(.55,24),Z(e,{transparent:!0,opacity:.93}),0,.47,0);n.scale.set(1,.85,1);let r=Q(qu(.1,12),Ku(X.shine,{transparent:!0,opacity:.85}),-.22,.74,.3);r.scale.set(1,.6,.6);let i=qu(.07,12),a=Q(i,Z(X.jellyFace),-.17,.55,.5),o=Q(i,Z(X.jellyFace),.17,.55,.5),s=new di(.2,.045,.05),c=Q(s,Z(X.jellyFace),-.17,.68,.47),l=Q(s,Z(X.jellyFace),.17,.68,.47);c.rotation.z=-.45,l.rotation.z=.45;let u=Q(new za(.08,.02,8,14,Math.PI),Z(X.jellyFace),0,.36,.53);return t.add(n,r,a,o,c,l,u),{root:t,parts:{body:n}}}function id(){let e=new En,t=[[0,0,0,1,X.boss],[-.95,-.15,0,.7,X.boss],[.95,-.15,0,.7,X.boss],[0,.6,-.15,.75,X.boss],[-.55,.42,.15,.6,X.boss],[.55,.42,.15,.6,X.boss],[0,-.35,-.3,.8,X.bossShade]];for(let[n,r,i,a,o]of t)e.add(Q(qu(a,24),Z(o),n,r,i));let n=qu(.1,14),r=Q(n,Z(X.bossFace),-.3,.08,.95),i=Q(n,Z(X.bossFace),.3,.08,.95);r.scale.set(1,1.2,.6),i.scale.set(1,1.2,.6);let a=new di(.3,.06,.06),o=Q(a,Z(X.bossFace),-.3,.3,.95),s=Q(a,Z(X.bossFace),.3,.3,.95);o.rotation.z=-.4,s.rotation.z=.4;let c=Q(new za(.13,.035,8,16,Math.PI),Z(X.bossFace),0,-.22,.98),l=qu(.1,12),u=Q(l,Ku(X.bossCheek,{transparent:!0,opacity:.6}),-.55,-.1,.85),d=Q(l,Ku(X.bossCheek,{transparent:!0,opacity:.6}),.55,-.1,.85);return u.scale.set(1.3,.7,.4),d.scale.set(1.3,.7,.4),e.add(r,i,o,s,c,u,d),{root:e,parts:{}}}function ad(e){let t=new En;t.add(Q(new pi(.025,.03,.32,8),Z(X.flowerStem),0,.16,0));let n=Q(qu(.07,10),Z(X.flowerStem),.07,.1,0);n.scale.set(1.2,.4,.6),t.add(n);let r=new En;r.position.y=.34,r.rotation.x=-.5,r.add(Q(qu(.07,12),Z(X.flowerCenter)));let i=qu(.075,12);for(let t=0;t<5;t++){let n=t/5*Math.PI*2,a=Q(i,Z(e),Math.cos(n)*.12,Math.sin(n)*.12,-.01);a.scale.set(1,1,.45),r.add(a)}return t.add(r),t}function od(e,t){let n=Math.min(t,359.9)*Math.PI/180,r=new $r(new za(e*.8,.13,6,40,n),Ku(X.swipe,{transparent:!0,opacity:.9,depthWrite:!1,blending:2}));return r.rotation.set(-Math.PI/2,0,-Math.PI/2-n/2),r.position.y=.55,r}function sd(){let e=new En,t=Q(new Fa(.9,1,48),Ku(X.telegraphRing,{transparent:!0,opacity:.7,depthWrite:!1,side:2}));t.rotation.x=-Math.PI/2;let n=Q(new fi(1,48),Ku(X.telegraphFill,{transparent:!0,opacity:.45,depthWrite:!1,side:2}));return n.rotation.x=-Math.PI/2,n.position.y=.005,e.add(t,n),e.renderOrder=2,{root:e,ring:t,fill:n}}function cd(){let e=new En,t=Q(qu(.3,16),Z(X.raindrop,{transparent:!0,opacity:.9}),0,0,0),n=Q(new mi(.26,.45,16),Z(X.raindrop,{transparent:!0,opacity:.9}),0,.3,0),r=Q(qu(.06,8),Ku(X.shine),-.1,.06,.24);return e.add(t,n,r),e}function ld(){let e=new En,t=Q(new Na(.55,0),Z(X.thunder,{emissive:8020992})),n=Q(qu(.75,16),Ku(X.thunder,{transparent:!0,opacity:.3,depthWrite:!1}));return e.add(t,n),e}function ud(e){let t=new En,n=Q(qu(e,32),Ku(X.shield,{transparent:!0,opacity:.16,depthWrite:!1})),r=Q(new za(e,.05,8,48),Ku(X.shield,{transparent:!0,opacity:.6,depthWrite:!1}));return r.rotation.x=Math.PI/2,t.add(n,r),t}var dd=new W,fd=class{constructor(e,t,n={}){this.game=e,this.group=new En,this.group.position.copy(t),this.floater=new En,this.squash=new En,this.model=id(),this.squash.add(this.model.root),this.floater.add(this.squash),this.shadow=ed(Ou.radius*1.1),this.group.add(this.floater,this.shadow),this.mats=Zu(this.model.root),e.world.add(this.group),this.radius=Ou.radius,this.baseHp=Ou.hp,this.shields=n.shields??0,this.bonusPer=this.shields>0?(n.bonusHp??0)/this.shields:0,this.maxHp=this.baseHp+this.bonusPer*this.shields,this.hp=this.maxHp,this.bubbles=[];for(let e=0;e<this.shields;e++){let t=ud(Ou.radius*1.2+e*.3);this.squash.add(t),this.bubbles.push(t)}this.state=`enter`,this.t=0,this.time=0,this.height=Ou.enterHeight,this.cooldown=Ou.firstAttackDelay,this.patternIndex=0,this.pattern=`rain`,this.kb=new W,this.spring=new Hu(160,9),this.flash=0,this.yaw=0,this.burstTimer=0}get position(){return this.group.position}get targetable(){return this.state===`idle`||this.state===`cast`}get angry(){return this.hp<this.baseHp*Ou.angryAt}update(e){if(e<=0)return;let t=this.game;this.t+=e,this.time+=e,this.flash=Math.max(0,this.flash-e),this.position.addScaledVector(this.kb,e),this.kb.multiplyScalar(Math.exp(-Ou.knockbackFriction*e)),dd.subVectors(t.player.position,this.position).setY(0);let n=dd.length();n>.001&&dd.divideScalar(n);let r=1,i=0;switch(this.state){case`enter`:{let e=Pu(this.t/Ou.enterTime,0,1);this.height=Fu(Ou.enterHeight,Ou.floatHeight,Bu(e)),e>=1&&(this.state=`idle`,this.t=0,t.shake(.35),this.spring.kick(4));break}case`idle`:{let n=new W().copy(t.player.position).addScaledVector(t.camForward,Ou.keepDistance);Vu(n,this.radius),n.sub(this.position).setY(0);let r=n.length();r>.3&&this.position.addScaledVector(n.divideScalar(r),Math.min(r,Ou.moveSpeed*e)),this.cooldown-=e,this.cooldown<=0&&t.player.targetable&&(this.pattern=Ou.pattern[this.patternIndex++%Ou.pattern.length],this.state=`cast`,this.t=0);break}case`cast`:{let e=Pu(this.t/Ou.castTime,0,1);r=1+.18*Math.sin(e*Math.PI),i=Math.sin(this.t*30)*.08*e,e>=1&&(this.fire(this.pattern),this.state=`idle`,this.t=0,this.cooldown=this.angry?Ou.cooldownAngry:Ou.cooldown,this.spring.kick(-3));break}case`pop`:{let n=Pu(this.t/Ou.popTime,0,1);if(i=Math.sin(this.t*40)*.15*(1-n),r=n<.75?1+n*.4:1.3*(1-(n-.75)/.25),this.burstTimer-=e,this.burstTimer<=0&&n<.8&&(this.burstTimer=.12,dd.copy(this.position).setY(this.height).add(new W((Math.random()-.5)*2,(Math.random()-.5)*1.5,(Math.random()-.5)*2)),t.particles.burst(dd,{count:8,kinds:[`star`,`heart`],colors:[...X.particleStar,...X.particleHeart],speed:5,up:4,size:.24,life:.8})),n>=1){this.state=`gone`,this.group.visible=!1,dd.copy(this.position).setY(1.5),t.particles.burst(dd,{count:Mu.particles.bossPop,kinds:[`star`,`heart`,`dot`],colors:[...X.particleStar,...X.particleHeart,X.boss],speed:8,up:7,size:.3,life:1.2}),t.shake(Mu.bossPopShake);for(let e=0;e<7;e++){let n=e/7*Math.PI*2;t.spawnFlower(new W(this.position.x+Math.cos(n)*1.3,0,this.position.z+Math.sin(n)*1.3))}t.onBossDefeated()}break}}Vu(this.position,this.radius*.5),this.state!==`pop`&&n>.01&&(this.yaw=Ru(this.yaw,Math.atan2(dd.x,dd.z),Iu(3,e))),this.group.rotation.y=this.yaw;let a=this.spring.update(e);this.floater.position.y=this.height+Math.sin(this.time*2)*.15,this.floater.rotation.z=i;let o=Math.max(r,1e-4);this.squash.scale.set((1+a*.5)*o,(1-a)*o,(1+a*.5)*o),this.shadow.scale.setScalar(Pu(1.4-this.height*.1,.3,1.2)*Math.min(1,o)),$u(this.mats,+(this.flash>0)),this.bubbles.forEach((e,t)=>{e.rotation.y=this.time*(.6+t*.25),e.rotation.z=Math.sin(this.time*1.5+t)*.2}),t.hud.setBossHp(this.hp,this.baseHp,this.maxHp)}popShield(){let e=this.game,t=this.bubbles.pop();this.squash.remove(t),this.shields--,e.hud.setBossShields(this.shields),dd.copy(this.position).setY(this.height),e.particles.burst(dd,{count:22,kinds:[`dot`,`star`],colors:X.particleShield,speed:7,up:3,size:.22,life:.7,spread:2}),e.shake(.3),e.hud.showBanner(this.shields>0?`Pop!`:`No more shields!`)}fire(e){let t=this.game,n=t.player.position;if(e===`rain`){let e=Ou.rain,r=this.angry?e.countAngry:e.count;for(let i=0;i<r;i++){let r=new W(n.x,0,n.z);if(i>0){let t=Math.random()*Math.PI*2,n=Math.sqrt(Math.random())*e.spread;r.x+=Math.cos(t)*n,r.z+=Math.sin(t)*n}Vu(r,e.radius),t.addHazard(new pd(t,{kind:`rain`,pos:r,radius:e.radius,telegraph:e.telegraph,damage:e.damage,delay:i*e.stagger}))}}else{let e=Ou.thunder;if(t.addHazard(new pd(t,{kind:`thunder`,pos:new W(n.x,0,n.z),radius:e.radius,telegraph:e.telegraph,damage:e.damage,delay:0})),this.angry)for(let r=0;r<e.extraAngry;r++){let i=Math.random()*Math.PI*2,a=new W(n.x+Math.cos(i)*e.extraOffset,0,n.z+Math.sin(i)*e.extraOffset);Vu(a,e.radius),t.addHazard(new pd(t,{kind:`thunder`,pos:a,radius:e.radius*.8,telegraph:e.telegraph,damage:e.damage,delay:e.extraDelay*(r+1)}))}}}takeHit(e,t,n,r){if(!this.targetable)return!1;let i=this.game;for(this.hp=Math.max(0,this.hp-e);this.shields>0&&this.hp<=this.baseHp+(this.shields-1)*this.bonusPer;)this.popShield();return this.flash=Mu.flashTime,this.kb.copy(t).multiplyScalar(n*Ou.knockbackScale),this.spring.kick(Mu.hitSquashKick*.6),dd.copy(this.position).setY(this.height+1.4),i.numbers.spawn(dd,e,r?.big),dd.setY(this.height-.3),i.particles.burst(dd,{count:Mu.particles.hit,kinds:[`star`,`heart`],colors:[...X.particleStar,...X.particleHeart],speed:3.5,up:3,size:.2,life:.55}),this.hp<=0&&(this.state=`pop`,this.t=0,i.clearHazards(),i.onBossPopping()),!0}},pd=class{constructor(e,t){this.game=e,this.kind=t.kind,this.pos=t.pos.clone(),this.radius=t.radius,this.telegraph=t.telegraph,this.damage=t.damage,this.t=-t.delay,this.landed=!1,this.after=0,this.done=!1,this.tele=sd(),this.tele.root.scale.setScalar(this.radius),this.tele.root.position.set(this.pos.x,.03,this.pos.z),this.tele.root.visible=!1,this.faller=this.kind===`rain`?cd():ld(),this.faller.scale.setScalar(this.kind===`rain`?1.2:this.radius*.6),this.faller.position.set(this.pos.x,ju.fallHeight,this.pos.z),this.faller.visible=!1,e.world.add(this.tele.root,this.faller)}update(e){if(!(e<=0||this.done)&&(this.game,this.t+=e,!(this.t<0))){if(this.landed){this.after+=e;let t=Pu(this.after/ju.splashTime,0,1),n=this.kind===`rain`?1.2:this.radius*.6;this.faller.scale.set(n*(1+t),n*Math.max(.001,1-t),n*(1+t)),t>=1&&this.dispose()}else{this.tele.root.visible=!0;let t=Pu(this.t/this.telegraph,0,1);this.tele.fill.scale.setScalar(Math.max(t,.001)),this.tele.ring.material.opacity=.45+.3*Math.abs(Math.sin(this.t*(6+t*10)));let n=this.telegraph-ju.fallTime;if(this.t>=n){this.faller.visible=!0;let t=Pu((this.t-n)/ju.fallTime,0,1);this.faller.position.y=Fu(ju.fallHeight,.4,t*t),this.faller.rotation.y+=e*8}this.t>=this.telegraph&&this.land()}}}land(){let e=this.game;this.landed=!0,this.tele.root.visible=!1;let t=e.player;Math.hypot(t.position.x-this.pos.x,t.position.z-this.pos.z)<=this.radius+ju.hitRadiusBonus&&t.takeHit(this.damage,this.pos),dd.copy(this.pos).setY(.3),this.kind===`rain`?(e.particles.burst(dd,{count:10,kinds:[`dot`],colors:X.particleRain,speed:3,up:3,size:.12,life:.5}),e.shake(.08)):(e.particles.burst(dd,{count:18,kinds:[`star`,`dot`],colors:[X.thunder,16777215],speed:6,up:4,size:.2,life:.6,spread:this.radius}),e.shake(.25))}dispose(){this.done=!0,this.game.world.remove(this.tele.root,this.faller)}},md=class{constructor(e,t){this.scene=e,this.camera=t,this.items=[],this.geos={star:Yu(),heart:Xu(),dot:new fi(1,14)}}burst(e,t={}){let n=t.count??8,r=t.kinds??[`star`],i=t.colors??X.particleStar,a=t.speed??3,o=t.up??3,s=t.size??.18,c=t.life??.6,l=t.gravity??-6,u=t.spread??.2;for(let t=0;t<n;t++){let n=r[t%r.length],d=new Vr({color:Lu(i),transparent:!0,depthWrite:!1,side:2}),f=new $r(this.geos[n],d);f.position.set(e.x+(Math.random()-.5)*u,e.y+(Math.random()-.5)*u,e.z+(Math.random()-.5)*u);let p=Math.random()*Math.PI*2,m=a*(.5+Math.random()*.5);this.items.push({m:f,vel:new W(Math.cos(p)*m,o*(.6+Math.random()*.6),Math.sin(p)*m),age:0,life:c*(.7+Math.random()*.6),size:s*(.7+Math.random()*.6),rot:Math.random()*Math.PI*2,spin:(Math.random()-.5)*8,gravity:l}),f.renderOrder=5,this.scene.add(f)}}update(e){for(let t=this.items.length-1;t>=0;t--){let n=this.items[t];if(n.age+=e,n.age>=n.life){this.scene.remove(n.m),n.m.material.dispose(),this.items.splice(t,1);continue}n.vel.y+=n.gravity*e,n.vel.multiplyScalar(Math.exp(-2*e)),n.m.position.addScaledVector(n.vel,e);let r=n.age/n.life,i=n.size*(r<.15?r/.15:1-Math.max(0,(r-.6)/.4));n.m.scale.setScalar(Math.max(i,1e-4)),n.rot+=n.spin*e,n.m.quaternion.copy(this.camera.quaternion),n.m.rotateZ(n.rot)}}clear(){for(let e of this.items)this.scene.remove(e.m),e.m.material.dispose();this.items.length=0}},hd=new W,gd=class{constructor(e,t){this.layer=e,this.camera=t,this.items=[]}spawn(e,t,n=!1){let r=document.createElement(`div`);r.className=`dmg`+(n?` big`:``);let i=document.createElement(`span`);i.textContent=t,i.style.color=n?Nu.damageBig:Lu(Nu.damage),r.appendChild(i),this.layer.appendChild(r),this.items.push({el:r,pos:e.clone(),vx:(Math.random()-.5)*1.2,age:0})}update(e){let{life:t,rise:n}=Mu.damageNumber,r=window.innerWidth,i=window.innerHeight;for(let a=this.items.length-1;a>=0;a--){let o=this.items[a];o.age+=e;let s=o.age/t;if(s>=1){o.el.remove(),this.items.splice(a,1);continue}o.pos.y+=n*e*(1-s),o.pos.x+=o.vx*e,hd.copy(o.pos).project(this.camera);let c=(hd.x*.5+.5)*r,l=(-hd.y*.5+.5)*i;o.el.style.transform=`translate(${c}px, ${l}px)`,o.el.style.opacity=s>.7?String(1-(s-.7)/.3):`1`}}clear(){for(let e of this.items)e.el.remove();this.items.length=0}},_d=class{constructor(){this.trauma=0,this.offset=new W}add(e){this.trauma=Math.min(1,this.trauma+e)}update(e){this.trauma=Math.max(0,this.trauma-Mu.shakeDecay*e);let t=this.trauma*this.trauma*Mu.shakeMax;return this.offset.set((Math.random()*2-1)*t,(Math.random()*2-1)*t,(Math.random()*2-1)*t),this.offset}},vd={};function yd(e){return`./${Au.dir}${e}`}function bd(e,t){if(vd[e])return t(vd[e]);let n=new Image;n.onload=()=>t(vd[e]=`ok`),n.onerror=()=>t(vd[e]=`missing`),n.src=yd(e)}var xd=class{constructor(e){this.el=document.createElement(`div`),this.el.className=`mochi`,this.el.style.setProperty(`--mochi-size`,`${Au.size}px`),this.el.style.setProperty(`--mochi-size-narrow`,`${Au.sizeNarrow}px`),this.bubble=document.createElement(`div`),this.bubble.className=`mochi-bubble`,this.sprite=document.createElement(`div`),this.sprite.className=`mochi-sprite`,this.sprite.setAttribute(`aria-hidden`,`true`),this.el.append(this.bubble,this.sprite),e.appendChild(this.el),this.state=null,this.token=0,this.sprite.addEventListener(`animationend`,()=>{let e=this.after;this.after=null,e&&this.play(e)});for(let e of Object.values(Au.sheets))bd(e.file,()=>{})}say(e){this.bubble.textContent=e,this.bubble.classList.toggle(`empty`,!e),this.bubble.classList.remove(`pop`),this.bubble.offsetWidth,this.bubble.classList.add(`pop`)}play(e,{loops:t=0,then:n=null}={}){let r=Au.sheets[e];if(!r)return;this.state=e,this.after=t>0?n:null;let i=++this.token;bd(r.file,e=>{if(i!==this.token)return;let n=this.sprite;if(e===`missing`){if(n.classList.add(`missing`),n.style.animation=`none`,n.style.backgroundImage=`none`,this.after){let e=this.after;this.after=null,this.play(e)}return}n.classList.remove(`missing`),n.style.setProperty(`--frames`,r.frames),n.style.backgroundImage=`url("${yd(r.file)}")`,n.style.animation=`none`,n.offsetWidth;let a=r.frames/r.fps;n.style.animation=`mochi-play ${a}s steps(${r.frames}) ${t>0?t:`infinite`}`})}},Sd={recharge:{title:`Magic Recharge`,sub:`Answer to get a heart back!`},gate:{title:`Cloud Gate`,sub:`Break the cloud's shields!`}},Cd=[[`Digit1`,`Numpad1`],[`Digit2`,`Numpad2`],[`Digit3`,`Numpad3`],[`Digit4`,`Numpad4`]],wd=[`Enter`,`NumpadEnter`,`Space`],Td=e=>String(e).replace(/[&<>"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`})[e]),Ed=`<svg class="star-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 1.8l3.1 6.6 7.1.9-5.2 4.9 1.3 7.1L12 17.8l-6.3 3.5 1.3-7.1L1.8 9.3l7.1-.9z"/></svg>`,Dd=`<svg class="shield-svg" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10"/></svg>`,Od=class{constructor(){this.el=document.getElementById(`screen-quiz`),this.card=document.getElementById(`quiz-card`),this.mochi=new xd(document.getElementById(`quiz-mochi`)),this.active=!1,this.timer=null,this.card.addEventListener(`mousedown`,e=>e.preventDefault()),this.card.addEventListener(`click`,e=>{e.stopPropagation();let t=e.target.closest(`button`);t&&(t.dataset.choice!==void 0&&this.choose(Number(t.dataset.choice)),t.dataset.act===`go`&&this.go())})}open({kind:e,count:t,session:n,onCorrect:r,onDone:i}){this.close(),Object.assign(this,{kind:e,count:t,session:n,onCorrect:r,onDone:i}),this.index=0,this.solved=0,this.active=!0,this.el.classList.remove(`hidden`),this.nextQuestion()}close(){clearTimeout(this.timer),this.active=!1,this.el.classList.add(`hidden`)}nextQuestion(){if(this.index>=this.count)return this.finish();let{question:e,intro:t,skill:n}=this.session.next();this.q=e,this.skill=n,this.tries=0,this.picked=-1,this.choices=e.choices.slice(),this.phase=t?`intro`:`ask`,this.intro=t,this.mochi.play(`thinking`),this.mochi.say(Au.lines.thinking),this.render()}choose(e){if(!(!this.active||this.phase!==`ask`||e<0||e>=this.choices.length)){if(this.picked=e,this.choices[e]===this.q.answer){let e=this.tries===0?`first`:`retry`;this.session.report(this.q.skill,e),this.solved++,this.rewardText=this.onCorrect?.(this.kind),this.mochi.play(`happy`,{loops:Au.happyLoops,then:`thinking`}),this.mochi.say(Au.lines.happy),this.phase=`praise`,this.render(),this.timer=setTimeout(()=>{this.index++,this.nextQuestion()},ku.praiseTime*1e3);return}this.tries++,this.mochi.play(`oops`,{loops:Au.oopsLoops,then:`thinking`}),this.tries===1?(this.mochi.say(Au.lines.oops),this.wrongText=this.choices[e],this.choices=kd(this.choices),this.picked=-1,this.phase=`retry`,this.render(),this.phase=`ask`):(this.session.report(this.q.skill,`missed`),this.mochi.say(Au.lines.reveal),this.phase=`reveal`,this.render())}}go(){this.active&&(this.phase===`intro`?(this.phase=`ask`,this.render()):this.phase===`reveal`&&(this.index++,this.nextQuestion()))}finish(){this.close(),this.onDone?.()}handleKeys(e){this.active&&(Cd.forEach((t,n)=>{e.wasPressed(t)&&this.choose(n)}),e.wasPressed(wd)&&this.go())}render(){let e=Sd[this.kind],t=`
      <div class="quiz-head">
        <div class="quiz-title">${e.title}</div>
        <div class="quiz-sub">${e.sub}</div>
        <div class="quiz-meter">${this.meter()}</div>
      </div>`,n;n=this.phase===`intro`?this.introHtml():this.questionHtml(),this.card.innerHTML=t+n,this.card.classList.remove(`bump`),this.card.offsetWidth,this.card.classList.add(`bump`)}meter(){return this.kind===`gate`?Array.from({length:this.count},(e,t)=>`<span class="shield ${t<this.solved?`broken`:``}">${Dd}</span>`).join(``)+`<span class="meter-text">Question ${Math.min(this.index+1,this.count)} of ${this.count}</span>`:Array.from({length:this.count},(e,t)=>`<span class="dot ${t<this.index?`done`:t===this.index?`now`:``}"></span>`).join(``)+`<span class="meter-text">Question ${Math.min(this.index+1,this.count)} of ${this.count}</span>`}introHtml(){let e=this.intro;return`
      <div class="intro">
        <div class="intro-tag">New!</div>
        <div class="intro-title">${Td(e.title)}</div>
        <p class="intro-text">${Td(e.text)}</p>
        <div class="intro-example">${Td(e.example)}</div>
        <div><button class="btn primary big" data-act="go">Got it! <kbd>Enter</kbd></button></div>
      </div>`}questionHtml(){let[e,t]=this.q.prompt.split(/\s{3,}/),n=this.phase===`praise`||this.phase===`reveal`,r=this.choices.map((e,t)=>{let r=`choice`;return this.phase===`praise`&&t===this.picked&&(r+=` correct`),this.phase===`reveal`&&(r+=e===this.q.answer?` correct`:t===this.picked?` wrong`:` faded`),e.length>18&&(r+=` long`),`<button class="${r}" data-choice="${t}" ${n?`disabled`:``}><span class="num">${t+1}</span><span class="txt">${Td(e)}</span></button>`}).join(``),i=``;if(this.phase===`retry`||this.phase===`ask`&&this.tries===1)i=`
        <div class="hint ${this.phase===`retry`?`shake`:``}"><span class="hint-tag">Hint</span> ${Td(this.q.hint)}</div>`;else if(this.phase===`praise`){let e=ku.praise[Math.floor(Math.random()*ku.praise.length)],t=Td(this.rewardText??(this.kind===`gate`?`Shield broken!`:`+1 heart`));i=`
        <div class="praise">
          <span class="spark s1">${Ed}</span><span class="spark s2">${Ed}</span><span class="spark s3">${Ed}</span>
          <div class="praise-text">${Td(e)}</div>
          <div class="reward">${t} &nbsp; +1 ${Ed}</div>
        </div>`}else this.phase===`reveal`&&(i=`
        <div class="reveal">
          <div class="reveal-answer">The answer is <b>${Td(this.q.answer)}</b></div>
          <p class="reveal-explain">${Td(this.q.explain)}</p>
          <button class="btn primary big" data-act="go">Next <kbd>Enter</kbd></button>
        </div>`);return`
      <div class="question">
        <div class="skill-name">${Td(this.skill.name)}</div>
        <div class="ask">${Td(e)}</div>
        ${t?`<div class="math">${Td(t)}</div>`:``}
      </div>
      <div class="choices ${this.choices.length===3?`three`:``}">${r}</div>
      ${i}`}};function kd(e){let t=e;for(let n=0;n<10&&(t=e.slice().sort(()=>Math.random()-.5),!t.some((t,n)=>t!==e[n]));n++);return t}var Ad=`<svg viewBox="0 0 32 29" aria-hidden="true"><path d="M16 28 C 6 20 0 14 0 8 C 0 3 4 0 8.5 0 C 12 0 14.5 2 16 4.5 C 17.5 2 20 0 23.5 0 C 28 0 32 3 32 8 C 32 14 26 20 16 28 Z"/></svg>`,jd=class{constructor(){let e=document.documentElement;for(let[t,n]of Object.entries(Nu))typeof n==`string`&&e.style.setProperty(`--${t.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}`,n);this.hearts=document.getElementById(`hearts`),this.wave=document.getElementById(`wave`),this.bossBar=document.getElementById(`boss-bar`),this.bossFill=document.getElementById(`boss-fill`),this.bossShield=document.getElementById(`boss-shield`),this.bossShields=document.getElementById(`boss-shields`),this.stars=document.getElementById(`stars`),this.starCount=document.getElementById(`star-count`),document.getElementById(`star-icon`).innerHTML=Ed,this.review=document.getElementById(`review-card`),this.reviewMochi=new xd(document.getElementById(`review-mochi`)),this.banner=document.getElementById(`banner`),this.numbers=document.getElementById(`numbers`),this.confetti=document.getElementById(`confetti`),this.screens={title:document.getElementById(`screen-title`),over:document.getElementById(`screen-over`),clear:document.getElementById(`screen-clear`),review:document.getElementById(`screen-review`)},this.hudEl=document.getElementById(`hud`),document.getElementById(`boss-name`).textContent=Ou.name;for(let e of document.querySelectorAll(`.version`))e.textContent=xu;this.heartCount=-1}setHearts(e,t,n=!1){if(this.heartCount!==t||this.hearts.children.length!==t){this.hearts.innerHTML=``;for(let e=0;e<t;e++){let e=document.createElement(`div`);e.className=`heart`,e.innerHTML=Ad,this.hearts.appendChild(e)}this.heartCount=t}[...this.hearts.children].forEach((t,r)=>{let i=t.classList.contains(`full`);t.classList.toggle(`full`,r<e),n&&i&&r>=e&&(t.classList.remove(`lost`),t.offsetWidth,t.classList.add(`lost`))})}setWave(e){this.wave.textContent=e,this.wave.classList.remove(`bump`),this.wave.offsetWidth,this.wave.classList.add(`bump`)}showBossBar(e){this.bossBar.classList.toggle(`hidden`,!e)}setBossHp(e,t=e,n=e||1){this.bossFill.style.width=`${Math.max(0,Math.min(e,t))/n*100}%`,this.bossShield.style.width=`${Math.max(0,e-t)/n*100}%`}setBossShields(e){this.bossShields.textContent=e>0?`${e} shield${e>1?`s`:``}`:``}setStars(e,t=!1){this.starCount.textContent=String(e),t&&(this.stars.classList.remove(`bump`),this.stars.offsetWidth,this.stars.classList.add(`bump`))}showReview({stars:e,asked:t,firstTry:n,practice:r}){let i=e=>String(e).replace(/[&<>"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`})[e]),a;a=t===0?`<p class="rv-line">No questions this time.</p>`:r.length===0?`<p class="rv-line">You got all <b>${t}</b> right on the first try!</p><p class="rv-super">Super star!</p>`:`<p class="rv-line">You got <b>${n}</b> of <b>${t}</b> right on the first try!</p>
        <div class="rv-practice"><div class="rv-label">Let's practice:</div>${r.map(e=>`<div class="rv-skill">${i(e)}</div>`).join(``)}</div>`,this.review.innerHTML=`
      <h2 class="rv-title">Star Review</h2>
      <div class="rv-stars">${Ed}<span>&times; ${e}</span></div>
      ${a}
      <p class="rv-again">Play again <kbd>R</kbd></p>`,this.showScreen(`review`),this.reviewMochi.play(`happy`),this.reviewMochi.say(Au.lines.review)}showBanner(e){this.banner.textContent=e,this.banner.classList.remove(`show`),this.banner.offsetWidth,this.banner.classList.add(`show`)}showScreen(e){for(let[t,n]of Object.entries(this.screens))n.classList.toggle(`hidden`,t!==e);this.hudEl.classList.toggle(`hidden`,e===`title`)}burstConfetti(){this.clearConfetti();for(let e=0;e<Mu.confettiCount;e++){let e=document.createElement(`i`);e.style.setProperty(`--x`,`${Math.random()*100}vw`),e.style.setProperty(`--drift`,`${(Math.random()-.5)*30}vw`),e.style.setProperty(`--spin`,`${(Math.random()-.5)*1440}deg`),e.style.setProperty(`--dur`,`${2.4+Math.random()*2.4}s`),e.style.setProperty(`--delay`,`${Math.random()*1.2}s`),e.style.background=Lu(Nu.confetti),Math.random()<.35&&e.classList.add(`round`),this.confetti.appendChild(e)}}clearConfetti(){this.confetti.innerHTML=``}},Md=new Set([`Space`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`ShiftLeft`,`ShiftRight`]),Nd=class{constructor(){this.down=new Set,this.pressed=new Set,this.mousePressed=!1,this.mouse={x:0,y:0},window.addEventListener(`keydown`,e=>{Md.has(e.code)&&e.preventDefault(),e.repeat||this.pressed.add(e.code),this.down.add(e.code)}),window.addEventListener(`keyup`,e=>this.down.delete(e.code)),window.addEventListener(`blur`,()=>this.down.clear()),window.addEventListener(`mousemove`,e=>{this.mouse.x=e.clientX,this.mouse.y=e.clientY}),window.addEventListener(`mousedown`,e=>{this.mouse.x=e.clientX,this.mouse.y=e.clientY,e.button===0&&(this.mousePressed=!0)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),document.querySelectorAll(`[data-key]`).forEach(e=>{let t=e.dataset.key,n=e=>{e.preventDefault(),this.down.add(t),this.pressed.add(t)},r=e=>{e.preventDefault(),this.down.delete(t)};e.addEventListener(`pointerdown`,n,{passive:!1}),e.addEventListener(`pointerup`,r,{passive:!1}),e.addEventListener(`pointercancel`,r,{passive:!1}),e.addEventListener(`pointerleave`,r,{passive:!1})})}isDown(e){return e.some(e=>this.down.has(e))}wasPressed(e){return e.some(e=>this.pressed.has(e))}endFrame(){this.pressed.clear(),this.mousePressed=!1}},Pd=new W,Fd=class{constructor(e,t,n,r){this.game=e,this.group=new En,this.group.position.copy(t),this.hopper=new En,this.squash=new En;let i=X.jelly[n%X.jelly.length];this.model=rd(i),this.squash.add(this.model.root),this.hopper.add(this.squash),this.shadow=ed(Eu.radius*1.15),this.group.add(this.hopper,this.shadow),this.mats=Zu(this.model.root),this.squash.scale.setScalar(1e-4),this.shadow.visible=!1,e.world.add(this.group),this.color=i,this.radius=Eu.radius,this.hp=Eu.hp,this.state=`spawn`,this.t=-r,this.kb=new W,this.lungeDir=new W(0,0,1),this.spring=new Hu(200,10),this.flash=0,this.hopClock=Eu.hopDuration+Math.random()*Eu.hopInterval,this.yaw=Math.random()*Math.PI*2,this.hitThisLunge=!1}get position(){return this.group.position}get targetable(){return this.state!==`spawn`&&this.state!==`pop`&&this.state!==`gone`}update(e){if(e<=0)return;let t=Eu;this.t+=e,this.flash=Math.max(0,this.flash-e),this.position.addScaledVector(this.kb,e),this.kb.multiplyScalar(Math.exp(-t.knockbackFriction*e));let n=this.game.player;Pd.subVectors(n.position,this.position).setY(0);let r=Pd.length();r>.001&&Pd.divideScalar(r);let i=0,a=1,o=1,s=1,c=!0;switch(this.state){case`spawn`:{if(this.t<0){s=0;break}this.shadow.visible=!0;let e=Pu(this.t/t.spawnTime,0,1);s=zu(e),e>=1&&this.setState(`chase`);break}case`chase`:{let s=t.hopDuration+t.hopInterval;this.hopClock+=e;let c=this.hopClock%s;if(c<t.hopDuration){let n=Math.sin(c/t.hopDuration*Math.PI);i=n*t.hopHeight,o=1+.25*n,a=1-.12*n,r>.01&&this.position.addScaledVector(Pd,t.hopSpeed*e)}else{let e=(c-t.hopDuration)/t.hopInterval;if(e<.2){let t=1-e/.2;o=1-.22*t,a=1+.15*t}else if(e>.7){let t=(e-.7)/.3;o=1-.18*t,a=1+.1*t}r<=t.attackRange&&n.targetable&&this.setState(`windup`)}break}case`windup`:{let e=Pu(this.t/t.windup,0,1);o=1-.28*e+Math.sin(this.t*40)*.04*e,a=1+.2*e,e<.7&&r>.01&&this.lungeDir.copy(Pd),e>=1&&(this.setState(`lunge`),this.hitThisLunge=!1,this.spring.kick(-3));break}case`lunge`:{let s=Pu(this.t/t.lungeDuration,0,1);this.position.addScaledVector(this.lungeDir,t.lungeSpeed*e),i=Math.sin(s*Math.PI)*.4,o=1.2,a=.9,c=!1,!this.hitThisLunge&&r<=this.radius+n.radius&&n.takeHit(t.damage,this.position)&&(this.hitThisLunge=!0),s>=1&&(this.setState(`rest`),this.spring.kick(3));break}case`rest`:o=1+Math.sin(this.t*6)*.03,this.t>=t.rest&&(this.setState(`chase`),this.hopClock=t.hopDuration);break;case`hitstun`:c=!1,this.t>=t.hitstun&&(this.setState(`chase`),this.hopClock=t.hopDuration+t.hopInterval*.5);break;case`pop`:{let e=Pu(this.t/t.popTime,0,1);s=e<.4?1+e/.4*.4:1.4*(1-(e-.4)/.6),c=!1,this.shadow.scale.setScalar(Math.max(.001,1-e)),e>=1&&(this.state=`gone`,this.group.visible=!1);break}}Vu(this.position,this.radius),c&&r>.01&&(this.yaw=Ru(this.yaw,Math.atan2(Pd.x,Pd.z),Iu(8,e))),this.group.rotation.y=this.yaw;let l=this.spring.update(e);this.hopper.position.y=i;let u=Math.max(s,1e-4);this.squash.scale.set(a*(1+l*.5)*u,o*(1-l)*u,a*(1+l*.5)*u),this.state!==`pop`&&this.shadow.scale.setScalar(Math.max(.3,1-i*.6)*Math.min(1,s)),$u(this.mats,+(this.flash>0))}setState(e){this.state=e,this.t=0}takeHit(e,t,n,r){if(!this.targetable)return!1;let i=this.game;return this.hp-=e,this.flash=Mu.flashTime,this.kb.copy(t).multiplyScalar(n*Eu.knockbackScale),this.spring.kick(Mu.hitSquashKick*(r?.big?1.4:1)),Pd.copy(this.position).setY(1.3),i.numbers.spawn(Pd,e,r?.big),Pd.setY(.6),i.particles.burst(Pd,{count:Mu.particles.hit,kinds:[`star`,`star`,`heart`],colors:[...X.particleStar,...X.particleHeart],speed:3.5,up:3,size:.16,life:.5}),this.hp<=0?this.die():this.setState(`hitstun`),!0}die(){let e=this.game;this.setState(`pop`),Pd.copy(this.position).setY(.6),e.particles.burst(Pd,{count:Mu.particles.pop,kinds:[`star`,`heart`,`dot`],colors:[this.color,...X.particleStar],speed:4.5,up:4,size:.2,life:.8}),e.shake(Mu.enemyPopShake),e.spawnFlower(this.position)}},Id=new W,Ld=new W,Rd=.35,zd=class{constructor(e){this.game=e,this.group=new En,this.squash=new En,this.pivot=new En,this.pivot.position.y=Y.centerHeight,this.model=nd(),this.model.root.position.y=-Y.centerHeight,this.pivot.add(this.model.root),this.squash.add(this.pivot),this.group.add(this.squash,ed(Y.radius*1.3)),this.swipes=Y.combo.map(e=>{let t=od(e.range,e.arcDeg);return t.visible=!1,this.group.add(t),t}),this.mats=Zu(this.model.root),e.world.add(this.group),this.radius=Y.radius,this.hearts=Y.maxHearts,this.vel=new W,this.facing=new W(0,0,1),this.moveInput=new W,this.dashDir=new W,this.aim=null,this.state=`normal`,this.t=0,this.attackBuffer=0,this.dashBuffer=0,this.comboIndex=0,this.comboTimer=0,this.dashCooldown=0,this.invuln=0,this.iframes=0,this.flash=0,this.animT=0,this.spring=new Hu,this.controllable=!0,this.hitDone=!1,this.dizzyTimer=0}get position(){return this.group.position}get targetable(){return this.state!==`down`&&this.state!==`cheer`}readInput(e){if(this.moveInput.set(0,0,0),!this.controllable||this.state===`down`)return;let t=this.game,n=0,r=0;e.isDown(Su.up)&&(n+=1),e.isDown(Su.down)&&--n,e.isDown(Su.right)&&(r+=1),e.isDown(Su.left)&&--r,this.moveInput.copy(t.camForward).multiplyScalar(n).addScaledVector(t.camRight,r),this.moveInput.lengthSq()>0&&this.moveInput.normalize(),e.wasPressed(Su.attack)&&(this.attackBuffer=Y.inputBuffer,this.aim=null),e.mousePressed&&(this.attackBuffer=Y.inputBuffer,this.aim=t.mouseGround()),e.wasPressed(Su.dash)&&(this.dashBuffer=Y.inputBuffer)}update(e){if(e<=0)return;switch(this.animT+=e,this.attackBuffer=Math.max(0,this.attackBuffer-e),this.dashBuffer=Math.max(0,this.dashBuffer-e),this.comboTimer=Math.max(0,this.comboTimer-e),this.dashCooldown=Math.max(0,this.dashCooldown-e),this.invuln=Math.max(0,this.invuln-e),this.iframes=Math.max(0,this.iframes-e),this.flash=Math.max(0,this.flash-e),this.state){case`normal`:this.updateNormal(e);break;case`attack`:this.updateAttack(e);break;case`dash`:this.updateDash(e);break;case`hurt`:this.updateHurt(e);break;case`down`:this.updateDown(e);break;case`cheer`:this.updateCheer(e)}this.position.addScaledVector(this.vel,e),Vu(this.position,this.radius);let t=Math.atan2(this.facing.x,this.facing.z);this.group.rotation.y=Ru(this.group.rotation.y,t,Iu(Y.turnSharpness,e));let n=this.spring.update(e),r=this.state===`normal`?Math.sin(this.animT*3)*.025:0;this.squash.scale.set(1+n*.5,1-n+r,1+n*.5),$u(this.mats,+(this.flash>0));let i=this.invuln>0&&this.state!==`down`&&Math.floor(this.invuln*14)%2==0;this.model.root.visible=!i}updateNormal(e){Id.copy(this.moveInput).multiplyScalar(Y.moveSpeed),this.vel.lerp(Id,Iu(Y.accel,e)),this.moveInput.lengthSq()>0&&this.facing.copy(this.moveInput);let t=this.model.parts.wandPivot;t.rotation.x=Fu(t.rotation.x,Rd,Iu(12,e)),t.rotation.z=Fu(t.rotation.z,0,Iu(12,e)),this.pivot.rotation.y=0;let n=Pu(this.vel.length()/Y.moveSpeed,0,1);if(this.pivot.rotation.z=Math.sin(this.animT*14)*.12*n,this.pivot.position.y=Y.centerHeight+Math.abs(Math.sin(this.animT*14))*.08*n,this.dashBuffer>0&&this.dashCooldown<=0)return this.startDash();if(this.attackBuffer>0){let e=this.comboTimer>0?this.comboIndex+1:0;return this.startAttack(e%Y.combo.length)}}startAttack(e){this.state=`attack`,this.t=0,this.comboIndex=e,this.hitDone=!1,this.attackBuffer=0,this.comboTimer=0,this.aim?(Id.subVectors(this.aim,this.position).setY(0),Id.lengthSq()>.01&&this.facing.copy(Id.normalize())):this.moveInput.lengthSq()>0&&this.facing.copy(this.moveInput),this.aim=null,this.group.rotation.y=Math.atan2(this.facing.x,this.facing.z),this.pivot.rotation.set(0,0,0),this.pivot.position.y=Y.centerHeight,this.hideSwipes(),this.spring.kick(Mu.attackStretchKick)}updateAttack(e){let t=Y.combo[this.comboIndex];this.t+=e;let n=this.t,r=t.windup+t.active;n<r?this.vel.copy(this.facing).multiplyScalar(t.lunge/r):this.vel.multiplyScalar(Math.exp(-12*e));let i=this.model.parts.wandPivot,a=this.comboIndex===1?-1:1;if(n<t.windup)i.rotation.x=Fu(Rd,-1.4,n/t.windup),i.rotation.z=Fu(0,.6*a,n/t.windup);else if(n<r){let e=(n-t.windup)/t.active;i.rotation.x=Fu(-1.4,1.6,e),i.rotation.z=Fu(.6*a,-.6*a,e),t.arcDeg>=360&&(this.pivot.rotation.y=e*Math.PI*2)}else{let e=Pu((n-r)/t.recovery,0,1);i.rotation.x=Fu(1.6,Rd,e),i.rotation.z=Fu(-.6*a,0,e),this.pivot.rotation.y=0}!this.hitDone&&n>=t.windup&&(this.hitDone=!0,this.doHit(t));let o=this.swipes[this.comboIndex],s=r+Y.swipeLinger;if(n>=t.windup&&n<s){let e=(n-t.windup)/(s-t.windup);o.visible=!0,o.material.opacity=.95*(1-e*e),o.scale.setScalar(.75+e*.35)}else o.visible=!1;if(n>=r){if(this.dashBuffer>0&&this.dashCooldown<=0)return this.startDash();if(this.attackBuffer>0&&this.comboIndex<Y.combo.length-1&&n>=r+t.cancelAfter)return this.startAttack(this.comboIndex+1)}n>=r+t.recovery&&(this.state=`normal`,this.hideSwipes(),this.comboTimer=this.comboIndex<Y.combo.length-1?Y.comboWindow:0)}doHit(e){let t=this.game,n=e.arcDeg*Math.PI/360,r=0;for(let i of t.targets()){let t=i.position.x-this.position.x,a=i.position.z-this.position.z,o=Math.hypot(t,a);if(o>e.range+i.radius)continue;let s=e.arcDeg>=360||o<i.radius+this.radius+.2;if(!s){let e=(t*this.facing.x+a*this.facing.z)/o;s=Math.acos(Pu(e,-1,1))<=n+Math.atan2(i.radius,o)}s&&(o>.001?Ld.set(t/o,0,a/o):Ld.copy(this.facing),i.takeHit(e.damage,Ld,e.knockback,e)&&r++)}r&&(t.hitStop(e.hitstop),t.shake(e.shake)),Id.copy(this.facing).multiplyScalar(e.arcDeg>=360?0:e.range*.6).add(this.position),Id.y=.7,t.particles.burst(Id,{count:Mu.particles.swipe*(e.big?3:1),kinds:[`star`],speed:e.big?5:2.5,up:2,size:.14,life:.45,spread:e.big?1.5:.6})}startDash(){this.state=`dash`,this.t=0,this.dashBuffer=0,this.attackBuffer=0,this.hideSwipes(),this.dashDir.copy(this.moveInput.lengthSq()>0?this.moveInput:this.facing),this.facing.copy(this.dashDir),this.group.rotation.y=Math.atan2(this.facing.x,this.facing.z),this.iframes=Y.dash.iframes,this.pivot.position.y=Y.centerHeight,this.pivot.rotation.set(0,0,0),this.spring.kick(Mu.dashKick),Id.copy(this.position).setY(.2),this.game.particles.burst(Id,{count:6,kinds:[`dot`],colors:X.particleDust,speed:2,up:1,size:.14,life:.4,gravity:0})}updateDash(e){let t=Y.dash;this.t+=e;let n=Pu(this.t/t.duration,0,1);this.vel.copy(this.dashDir).multiplyScalar(t.speed*(1-n*.5)),this.pivot.rotation.x=n*Math.PI*2,n>=1&&(this.pivot.rotation.x=0,this.state=`normal`,this.dashCooldown=t.cooldown,this.vel.multiplyScalar(.3),this.spring.kick(2))}updateHurt(e){this.t+=e,this.vel.multiplyScalar(Math.exp(-8*e)),this.t>=Y.hurtStun&&(this.state=`normal`)}updateDown(e){this.t+=e,this.vel.multiplyScalar(Math.exp(-6*e)),this.pivot.rotation.z=Fu(this.pivot.rotation.z,1.35,Iu(8,e)),this.pivot.position.y=Fu(this.pivot.position.y,.35,Iu(8,e)),this.dizzyTimer-=e,this.dizzyTimer<=0&&(this.dizzyTimer=.25,Id.copy(this.position).setY(1.2),this.game.particles.burst(Id,{count:2,kinds:[`star`],speed:1.5,up:.8,size:.12,life:.6,gravity:0}))}updateCheer(e){this.t+=e,this.vel.multiplyScalar(Math.exp(-8*e)),this.pivot.position.y=Y.centerHeight+Math.abs(Math.sin(this.t*6))*.6,this.pivot.rotation.set(0,0,0),this.model.parts.wandPivot.rotation.x=-2.6+Math.sin(this.t*12)*.3,this.facing.copy(this.game.camForward).negate()}cheer(){this.state=`cheer`,this.t=0,this.controllable=!1,this.invuln=0,this.hideSwipes()}hideSwipes(){for(let e of this.swipes)e.visible=!1}takeHit(e,t){if(!this.targetable||this.invuln>0||this.iframes>0||!this.controllable)return!1;let n=this.game;return this.hearts=Math.max(0,this.hearts-e),n.hud.setHearts(this.hearts,Y.maxHearts,!0),Id.subVectors(this.position,t).setY(0),Id.lengthSq()<1e-4&&Id.copy(this.facing).negate(),Id.normalize(),this.vel.copy(Id).multiplyScalar(Y.hurtKnockback),this.flash=Mu.flashTime*1.5,this.spring.kick(Mu.hurtSquashKick),this.invuln=Y.hurtInvuln,this.hideSwipes(),this.pivot.rotation.set(0,0,0),this.pivot.position.y=Y.centerHeight,n.shake(Mu.hurtShake),n.hitStop(Mu.hurtHitstop),Id.copy(this.position).setY(1.1),n.particles.burst(Id,{count:5,kinds:[`heart`],colors:X.particleHeart,speed:2,up:3,size:.2,life:.7}),this.t=0,this.hearts<=0?(this.state=`down`,this.invuln=0,n.onPlayerDown()):this.state=`hurt`,!0}},Bd=t({default:()=>Vd}),Vd={id:`stage-01`,order:1,name:`Flower Meadow`,flow:[{type:`wave`,...Du.list[0]},{type:`quiz`,kind:`recharge`},{type:`wave`,...Du.list[1]},{type:`quiz`,kind:`gate`},{type:`boss`,name:Ou.name}],learning:{review:[`place-value`,`number-forms`,`compare`,`rounding`],preview:[`estimate-sum-diff`,`add-multi`,`subtract-multi`,`subtract-across-zeros`],ratio:.7,recharge:2,gate:3}},Hd=Object.values(Object.assign({"./stage-01.js":Bd})).map(e=>e.default).sort((e,t)=>e.order-t.order);function Ud(){let e=null;try{e=new URLSearchParams(window.location.search).get(`stage`)}catch{e=null}return Hd.find(t=>t.id===e)??Hd[0]}var Wd=()=>({asked:0,firstTry:0,retry:0,missed:0,level:1}),Gd=class{constructor(e=Kd()){this.storage=e,this.data=this.load()}load(){try{let e=this.storage?.getItem(ku.storageKey),t=e?JSON.parse(e):null;return t&&typeof t==`object`&&t.skills?t:{skills:{}}}catch{return{skills:{}}}}save(){try{this.storage?.setItem(ku.storageKey,JSON.stringify(this.data))}catch{}}get(e){return{...Wd(),...this.data.skills[e]??{}}}record(e,t,n){let r=this.get(e);r.asked++,r[t===`first`?`firstTry`:t===`retry`?`retry`:`missed`]++,r.level=n,this.data.skills[e]=r,this.save()}reset(){this.data={skills:{}};try{this.storage?.removeItem(ku.storageKey)}catch{}}};function Kd(){try{return typeof window<`u`?window.localStorage:null}catch{return null}}function qd(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var Jd=(e,t,n)=>t+Math.floor(e()*(n-t+1)),Yd=(e,t)=>t[Math.floor(e()*t.length)];function Xd(e,t){let n=t.slice();for(let t=n.length-1;t>0;t--){let r=Math.floor(e()*(t+1));[n[t],n[r]]=[n[r],n[t]]}return n}function $(e){let t=String(Math.abs(e)),n=``;for(let e=0;e<t.length;e++)e>0&&(t.length-e)%3==0&&(n+=`,`),n+=t[e];return e<0?`-`+n:n}var Zd=[`zero`,`one`,`two`,`three`,`four`,`five`,`six`,`seven`,`eight`,`nine`,`ten`,`eleven`,`twelve`,`thirteen`,`fourteen`,`fifteen`,`sixteen`,`seventeen`,`eighteen`,`nineteen`],Qd=[``,``,`twenty`,`thirty`,`forty`,`fifty`,`sixty`,`seventy`,`eighty`,`ninety`];function $d(e){let t=[],n=Math.floor(e/100),r=e%100;return n&&t.push(`${Zd[n]} hundred`),r&&(r<20?t.push(Zd[r]):t.push(Qd[Math.floor(r/10)]+(r%10?`-`+Zd[r%10]:``))),t.join(` `)}function ef(e){if(e===0)return`zero`;let t=Math.floor(e/1e3),n=e%1e3,r=[];return t&&r.push(`${$d(t)} thousand`),n&&r.push($d(n)),r.join(` `)}function tf(e){let t=String(e),n=[];for(let e=0;e<t.length;e++){let r=Number(t[e]);r&&n.push(r*10**(t.length-1-e))}return n}var nf=e=>tf(e).map($).join(` + `),rf=[`ones`,`tens`,`hundreds`,`thousands`,`ten thousands`,`hundred thousands`],af={10:`ten`,100:`hundred`,1e3:`thousand`},of=(e,t)=>Math.floor(e/10**t)%10,sf=e=>String(e).length;function cf(e,t){let n=Math.floor(e/t);return e%t*2>=t?(n+1)*t:n*t}function lf(e,t,{zeroFree:n=!1}={}){let r=Jd(e,1,9);for(let i=1;i<t;i++)r=r*10+(n?Jd(e,1,9):Jd(e,0,9));return r}function uf(e,t,n,{count:r=4,format:i=$,valid:a=df,fill:o}={}){let s=new Set([i(t)]),c=[],l=e=>{if(c.length>=r-1||e==null||!a(e))return;let t=i(e);s.has(t)||(s.add(t),c.push(e))};for(let e of n)l(e);for(let e=0;c.length<r-1&&o&&e<200;e++)l(o());let u=Xd(e,[t,...c]);return{answer:i(t),choices:u.map(i)}}function df(e){return typeof e!=`number`||Number.isInteger(e)&&e>=0&&e<=1e6}function ff(e,t){let n=[],r=0,i=Math.max(sf(e),sf(t));for(let a=0;a<i;a++)r=+(of(e,a)+of(t,a)+r>=10),r&&n.push(a);return n}function pf(e,t){let n=0,r=Math.max(sf(e),sf(t));for(let i=0;i<r;i++)n+=(of(e,i)+of(t,i))%10*10**i;return n}var mf=[``,`once`,`two times`,`three times`,`four times`,`five times`],hf=e=>e===0?``:e===1?`. Carry the 1 once`:`. Carry a 1 ${mf[e]}`,gf={id:`add-multi`,standard:`4.NBT.B.4`,chapter:2,name:`Adding big numbers`,intro:{title:`Adding big numbers`,text:`Line up the places. Add from the right. 10 or more? Carry 1 to the next place.`,example:`1,258 + 364 = 1,622`},generate(e,t){let n=qd(t),r,i,a;for(;e===1?(r=lf(n,3),i=lf(n,3)):e===2?(r=lf(n,4),i=lf(n,Jd(n,3,4))):(r=lf(n,5),i=lf(n,Jd(n,4,5))),a=ff(r,i),!([a.length===0,a.length===1,a.length>=2][e-1]&&r+i<1e6););let o=r+i,{answer:s,choices:c}=uf(n,o,[pf(r,i),...a.map(e=>o-10**(e+1)),o+10,o-100],{fill:()=>o+Jd(n,-9,9)*10**Jd(n,0,2)});return{prompt:`${$(r)} + ${$(i)} = ?`,answer:s,choices:c,hint:`Line up the places. Add the ones first. 10 or more? Carry 1 to the next place.`,explain:`Add each place from right to left${hf(a.length)}. ${$(r)} + ${$(i)} = ${$(o)}.`}}},_f={id:`compare`,standard:`4.NBT.A.2`,chapter:1,name:`Comparing numbers`,generate(e,t){let n=qd(t),r=[3,5,6][e-1],i,a,o=n();if(e===3&&o<.3)i=Jd(n,9e4,99999),a=Jd(n,1e5,109999);else if(o>.85)i=lf(n,r),a=i;else for(i=lf(n,r);;){let e=Jd(n,0,r-1),t=of(i,e),o=Jd(n,+(e===r-1),9);if(o!==t){a=i+(o-t)*10**e;break}}n()<.5&&([i,a]=[a,i]);let s=i<a?`<`:i>a?`>`:`=`,c;if(i===a)c=`Every digit is the same, so they are equal.`;else if(sf(i)!==sf(a))c=`${$(Math.max(i,a))} has more digits, so it is greater. ${$(i)} ${s} ${$(a)}.`;else{let e=sf(i)-1;for(;of(i,e)===of(a,e);)e--;let t=of(i,e),n=of(a,e);c=`Look at the ${rf[e]} place: ${t} is ${t>n?`greater`:`less`} than ${n}. So ${$(i)} ${s} ${$(a)}.`}return{prompt:`Which sign makes it true?   ${$(i)}  ?  ${$(a)}`,answer:s,choices:Xd(n,[`<`,`>`,`=`]),hint:`Start on the left. Find the first place where the digits are different.`,explain:c}}},vf={id:`estimate-sum-diff`,standard:`4.NBT.A.3`,chapter:2,name:`Estimating sums and differences`,intro:{title:`Estimate`,text:`Round each number first. Then add or subtract the easy numbers.`,example:`48 + 31  →  50 + 30 = 80`},generate(e,t){let n=qd(t),r=[2,3,4][e-1],i=10**(r-1),a=n()<.5,o,s;for(;o=lf(n,r),s=lf(n,r),!(o%i!==0&&s%i!==0&&(!a&&o<s&&([o,s]=[s,o]),!(!a&&cf(o,i)<=cf(s,i)))););let c=cf(o,i),l=cf(s,i),u=a?`+`:`−`,d=(e,t)=>a?e+t:e-t,f=d(c,l),p=af[i],{answer:m,choices:h}=uf(n,f,[d(o,s),d(c+i,l),d(c,l+i),d(c-i,l),d(cf(o,i*10),cf(s,i*10))],{fill:()=>f+Jd(n,-3,3)*i});return{prompt:`Round each number to the nearest ${p}. Then estimate:   ${$(o)} ${u} ${$(s)}`,answer:m,choices:h,hint:`Round ${$(o)} and ${$(s)} to the nearest ${p} first. Then ${a?`add`:`subtract`}.`,explain:`${$(o)} rounds to ${$(c)}. ${$(s)} rounds to ${$(l)}. ${$(c)} ${u} ${$(l)} = ${$(f)}.`}}};function yf(e,t,n){let r=Xd(e,Array.from({length:t-1},(e,t)=>t+1)).slice(0,n),i=``;for(let n=0;n<t;n++)i+=r.includes(n)?`0`:String(Jd(e,1,9));return Number(i)}function bf(e){let t=String(e),n=[],r=t=>{t&&t[0]!==`0`&&t.length<=6&&Number(t)!==e&&n.push(Number(t))},i=t.indexOf(`0`);i>0&&r(t.slice(0,i)+t.slice(i+1)),i>0&&r(t.slice(0,i)+`0`+t.slice(i));for(let e=1;e<t.length;e++)t[e]===`0`&&e+1<t.length&&t[e+1]!==`0`&&r(t.slice(0,e)+t[e+1]+`0`+t.slice(e+2)),t[e]===`0`&&t[e-1]!==`0`&&e-1>0&&r(t.slice(0,e-1)+`0`+t[e-1]+t.slice(e+1));return r(t+`0`),n}var xf={id:`number-forms`,standard:`4.NBT.A.2`,chapter:1,name:`Number names and forms`,generate(e,t){let n=qd(t),[r,i]=[[4,1],[5,1],[6,2]][e-1],a=yf(n,r,i),o=bf(a).filter(e=>e<=999999),s=()=>yf(n,r,i),c=Yd(n,[`to-words`,`from-words`,`from-expanded`,`to-expanded`]),l=`Look for the zeros. A zero holds a place but adds nothing.`;if(c===`to-words`){let{answer:e,choices:t}=uf(n,a,o,{format:ef,fill:s});return{prompt:`Which shows ${$(a)} in words?`,answer:e,choices:t,hint:l,explain:`${$(a)} is read "${ef(a)}".`}}if(c===`from-words`){let{answer:e,choices:t}=uf(n,a,o,{fill:s});return{prompt:`Which number is "${ef(a)}"?`,answer:e,choices:t,hint:l,explain:`"${ef(a)}" is written ${$(a)}.`}}if(c===`from-expanded`){let{answer:e,choices:t}=uf(n,a,o,{fill:s});return{prompt:`Which number is ${nf(a)}?`,answer:e,choices:t,hint:l,explain:`${nf(a)} = ${$(a)}. Empty places get a 0.`}}let{answer:u,choices:d}=uf(n,a,o,{format:nf,fill:s});return{prompt:`Which is the expanded form of ${$(a)}?`,answer:u,choices:d,hint:l,explain:`${$(a)} = ${nf(a)}. We skip the zeros.`}}},Sf={id:`place-value`,standard:`4.NBT.A.1`,chapter:1,name:`Place value`,generate(e,t){let n=qd(t),r=[4,5,6][e-1],i,a;for(;;){i=lf(n,r);let e=String(i),t=[];for(let n=0;n<e.length;n++)e[n]!==`0`&&e.indexOf(e[n])===e.lastIndexOf(e[n])&&t.push(e.length-1-n);if(t.length){a=t[Jd(n,0,t.length-1)];break}}let o=Math.floor(i/10**a)%10,s=o*10**a,{answer:c,choices:l}=uf(n,s,[o,o*10**(a+1),a>0?o*10**(a-1):null,o*10**(a+2)],{fill:()=>o*10**Jd(n,0,r)});return{prompt:`In ${$(i)}, what is the value of the ${o}?`,answer:c,choices:l,hint:`Find the ${o}. Name its place: ones, tens, hundreds, thousands...`,explain:a===0?`The ${o} is in the ones place. It is worth ${o}.`:`The ${o} is in the ${rf[a]} place. ${o} × ${$(10**a)} = ${$(s)}.`}}},Cf={id:`rounding`,standard:`4.NBT.A.3`,chapter:1,name:`Rounding`,generate(e,t){let n=qd(t),r=[10,100,1e3][e-1],i=Math.log10(r),a;for(;;){a=lf(n,e===3?Jd(n,5,6):[3,4][e-1]);let t=n();if(t<.3?a=a-of(a,i-1)*10**(i-1)+5*10**(i-1):t<.5&&(a=a-a%(r*10)+9*r+Jd(n,5,9)*10**(i-1)),a%r!==0&&a<1e6)break}let o=cf(a,r),s=Math.floor(a/r)*r,c=o===s?s+r:s,l=of(a,i-1),u=af[r],{answer:d,choices:f}=uf(n,o,[c,cf(a,r*10),r>10?cf(a,r/10):a,o+r*10],{fill:()=>o+Jd(n,-3,3)*r});return{prompt:`Round ${$(a)} to the nearest ${u}.`,answer:d,choices:f,hint:`Find the ${u}s place. Look at the next digit to the right. 5 or more: round up. Less than 5: round down.`,explain:`The digit after the ${u}s place is ${l}. ${l>=5?`5 or more, so round up`:`Less than 5, so round down`}: ${$(o)}.`}}};function wf(e,t){let n=[],r=0;for(let i=0;i<sf(e);i++)r=+(of(e,i)-r<of(t,i)),r&&n.push(i);return n}function Tf(e,t){let n=0;for(let r=0;r<sf(e);r++)n+=Math.abs(of(e,r)-of(t,r))*10**r;return n}var Ef=Object.fromEntries([Sf,xf,_f,Cf,vf,gf,{id:`subtract-multi`,standard:`4.NBT.B.4`,chapter:2,name:`Subtracting big numbers`,intro:{title:`Subtracting big numbers`,text:`Line up the places. Start with the ones. Top digit too small? Regroup 1 from the next place.`,example:`852 − 317 = 535`},generate(e,t){let n=qd(t),r,i,a;for(;e===1?(r=lf(n,3,{zeroFree:!0}),i=lf(n,3)):e===2?(r=lf(n,4,{zeroFree:!0}),i=lf(n,Jd(n,3,4))):(r=lf(n,5,{zeroFree:!0}),i=lf(n,Jd(n,4,5))),!(!(i>=r)&&(a=wf(r,i),[a.length===0,a.length===1,a.length>=2][e-1])););let o=r-i,{answer:s,choices:c}=uf(n,o,[Tf(r,i),...a.map(e=>o+10**(e+1)),o-10,o+100],{fill:()=>o+Jd(n,-9,9)*10**Jd(n,0,2)});return{prompt:`${$(r)} − ${$(i)} = ?`,answer:s,choices:c,hint:`Start with the ones. If the top digit is smaller, regroup 1 from the next place.`,explain:`${$(r)} − ${$(i)} = ${$(o)}. Check: ${$(o)} + ${$(i)} = ${$(r)}.`}}},{id:`subtract-across-zeros`,standard:`4.NBT.B.4`,chapter:2,name:`Subtracting across zeros`,intro:{title:`Subtracting across zeros`,text:`A zero has nothing to give. Go left to a digit that can. The zeros in between become 9s.`,example:`400 − 126: 400 = 3 hundreds, 9 tens, 10 ones. Answer: 274`},generate(e,t){let n=qd(t),r=Jd(n,2,9),i;i=e===1?r*100:e===2?Yd(n,[r*1e3,r*1e3,r*1e3+Jd(n,1,8)]):Yd(n,[r*1e4,r*1e4+Jd(n,1,8),r*1e4+Jd(n,1,9)*100]);let a=sf(i),o;for(;o=Jd(n,10**(a-2),i-1),!(o%10>i%10&&o%10!=0););let s=i-o,{answer:c,choices:l}=uf(n,s,[Tf(i,o),s+10**(a-1),s+100,s+10],{fill:()=>s+Jd(n,-9,9)*10**Jd(n,0,2)});return{prompt:`${$(i)} − ${$(o)} = ?`,answer:c,choices:l,hint:`You cannot take from 0. Go left to the first digit that is not 0. Regroup, and the zeros become 9s.`,explain:`Regroup across the zeros (they become 9s). ${$(i)} − ${$(o)} = ${$(s)}. Check: ${$(s)} + ${$(o)} = ${$(i)}.`}}}].map(e=>[e.id,e]));function Df(e,t,n){let r=Ef[e];if(!r)throw Error(`unknown skill: ${e}`);return{skill:e,level:t,seed:n,...r.generate(t,n>>>0)}}var Of=class{constructor(e,t,n=Math.random){this.cfg=e,this.progress=t,this.rng=n,this.levels={},this.streaks={},this.introShown=new Set,this.lastSkill=null,this.stats={asked:0,firstTry:0,stars:0,skills:{}}}levelOf(e){return e in this.levels||(this.levels[e]=this.progress.get(e).level||1),this.levels[e]}pickSkill(){let{review:e,preview:t,ratio:n}=this.cfg,r=t.length===0||e.length&&this.rng()<n?e:t,i=e=>this.stats.skills[e]?.asked??0,a=Math.min(...r.map(i)),o=r.filter(e=>i(e)===a&&e!==this.lastSkill);return o.length||(o=r.filter(e=>e!==this.lastSkill)),o.length||(o=r),o[Math.floor(this.rng()*o.length)]}next(){let e=this.pickSkill();this.lastSkill=e;let t=Ef[e],n=Df(e,this.levelOf(e),Math.floor(this.rng()*2**32)),r=null;return t.intro&&!this.introShown.has(e)&&this.progress.get(e).asked===0&&(r=t.intro,this.introShown.add(e)),{question:n,intro:r,skill:t}}report(e,t){let n=this.stats.skills[e]??={asked:0,firstTry:0,missed:0};n.asked++,this.stats.asked++,t===`first`?(n.firstTry++,this.stats.firstTry++,this.streaks[e]=(this.streaks[e]??0)+1,this.streaks[e]>=2&&(this.levels[e]=Math.min(3,this.levelOf(e)+1),this.streaks[e]=0)):(t===`missed`&&n.missed++,this.levels[e]=Math.max(1,this.levelOf(e)-1),this.streaks[e]=0),t!==`missed`&&this.stats.stars++,this.progress.record(e,t,this.levelOf(e))}needsPractice(e=2){return Object.entries(this.stats.skills).filter(([,e])=>e.firstTry<e.asked).sort((e,t)=>e[1].firstTry/e[1].asked-t[1].firstTry/t[1].asked||t[1].missed-e[1].missed).slice(0,e).map(([e])=>Ef[e].name)}},kf=e=>String(e).replace(/[&<>"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`})[e]),Af=class{constructor(e,t){this.progress=e,this.stage=t,this.el=document.getElementById(`screen-progress`),this.body=document.getElementById(`progress-body`),this.open=!1,document.getElementById(`progress-btn`).addEventListener(`click`,e=>{e.stopPropagation(),this.show()}),this.el.addEventListener(`click`,e=>{let t=e.target.closest(`[data-act]`)?.dataset.act;t===`close`&&this.hide(),t===`reset`&&this.render(!0),t===`reset-no`&&this.render(!1),t===`reset-yes`&&(this.progress.reset(),this.render(!1))})}show(){this.open=!0,this.render(!1),this.el.classList.remove(`hidden`)}hide(){this.open=!1,this.el.classList.add(`hidden`)}handleKeys(e){this.open&&e.wasPressed([`Escape`])&&this.hide()}render(e){let{review:t,preview:n}=this.stage.learning,r=(e,t)=>{let n=this.progress.get(e),r=n.firstTry+n.retry,i=n.asked?`${Math.round(n.firstTry/n.asked*100)}%`:`-`;return`<tr><td>${kf(Ef[e].name)} <span class="tag">${t}</span></td><td>${kf(Ef[e].standard)}</td>
        <td>${n.asked}</td><td>${n.firstTry}</td><td>${r}</td><td>${i}</td><td>${n.asked?n.level:`-`}</td></tr>`};this.body.innerHTML=`
      <table class="progress-table">
        <thead><tr><th>Skill</th><th>Standard</th><th>Tries</th><th>First try</th><th>Solved</th><th>First-try %</th><th>Level</th></tr></thead>
        <tbody>${t.map(e=>r(e,`review`)).join(``)}${n.map(e=>r(e,`new`)).join(``)}</tbody>
      </table>
      <p class="progress-note">Saved only in this browser.</p>
      <div class="progress-actions">
        ${e?`<span class="sure">Clear all progress?</span><button data-act="reset-yes" class="btn danger">Yes, clear</button><button data-act="reset-no" class="btn">No</button>`:`<button data-act="reset" class="btn">Reset</button><button data-act="close" class="btn primary">Close</button>`}
      </div>`}},jf=new W;new class{constructor(e){this.renderer=new bu({canvas:e,antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.outputColorSpace=Re,this.scene=new Fn,this.scene.background=new K(X.sky),this.scene.fog=new Pn(X.sky,30,60),this.camera=new Mo(Cu.fov,window.innerWidth/window.innerHeight,.1,200);let t=Dt.degToRad(Cu.yawDeg),n=Dt.degToRad(Cu.pitchDeg);this.camOffset=new W(Math.sin(t)*Math.cos(n)*Cu.distance,Math.sin(n)*Cu.distance,Math.cos(t)*Math.cos(n)*Cu.distance),this.camForward=new W(-Math.sin(t),0,-Math.cos(t)),this.camRight=new W(Math.cos(t),0,-Math.sin(t)),this.camTarget=new W,this.scene.add(new bo(X.hemiSky,X.hemiGround,wu.hemi));let r=new Fo(X.sun,wu.sun);r.position.set(6,12,8),this.scene.add(r),this.scene.add(td()),this.world=new En,this.scene.add(this.world),this.input=new Nd,this.hud=new jd,this.particles=new md(this.scene,this.camera),this.numbers=new gd(this.hud.numbers,this.camera),this.shaker=new _d,this.raycaster=new $o,this.groundPlane=new Nr(new W(0,1,0),0),this.mouseNdc=new U,window.addEventListener(`resize`,()=>this.onResize()),document.getElementById(`start-btn`).addEventListener(`click`,e=>{e.stopPropagation(),this.state===`title`&&!this.progressPanel.open&&this.start()}),this.stage=Ud(),this.waveTotal=this.stage.flow.filter(e=>e.type===`wave`).length,this.progress=new Gd,this.progressPanel=new Af(this.progress,this.stage),this.quiz=new Od,this.state=`title`,this.reset(),this.hud.showScreen(`title`),this.camTarget.copy(this.player.position),this.last=performance.now(),this.renderer.setAnimationLoop(()=>this.frame())}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}reset(){this.world.clear(),this.particles.clear(),this.numbers.clear(),this.hud.clearConfetti(),this.enemies=[],this.hazards=[],this.flowers=[],this.boss=null,this.player=new zd(this),this.stepIndex=-1,this.waveNumber=0,this.phase=`between`,this.phaseTimer=Du.firstDelay,this.hitstopTimer=0,this.endTimer=-1,this.hud.setHearts(Y.maxHearts,Y.maxHearts),this.hud.setWave(`Wave 1/${this.waveTotal}`),this.hud.showBossBar(!1),this.hud.setBossHp(1),this.hud.setBossShields(0),this.quiz.close(),this.session=new Of(this.stage.learning,this.progress),this.stars=0,this.hud.setStars(0),this.shields=this.stage.flow.some(e=>e.type===`quiz`&&e.kind===`gate`)?this.stage.learning.gate:0,this.reviewTimer=-1}start(){this.reset(),this.state=`play`,this.hud.showScreen(null),this.input.endFrame()}targets(){let e=this.enemies.filter(e=>e.targetable);return this.boss&&this.boss.targetable&&e.push(this.boss),e}hitStop(e){this.hitstopTimer=Math.max(this.hitstopTimer,e)}shake(e){this.shaker.add(e)}mouseGround(){this.mouseNdc.set(this.input.mouse.x/window.innerWidth*2-1,-(this.input.mouse.y/window.innerHeight)*2+1),this.raycaster.setFromCamera(this.mouseNdc,this.camera);let e=new W;return this.raycaster.ray.intersectPlane(this.groundPlane,e)?e:null}addHazard(e){this.hazards.push(e)}clearHazards(){for(let e of this.hazards)e.done||e.dispose();this.hazards.length=0}spawnFlower(e){let t=ad(Lu(X.flowerPetals));t.position.set(e.x+(Math.random()-.5)*.3,0,e.z+(Math.random()-.5)*.3),t.rotation.y=Math.random()*Math.PI*2,t.scale.setScalar(1e-4),this.world.add(t),this.flowers.push({root:t,t:-.15-Math.random()*.15,size:1.6+Math.random()*.8})}advance(){this.stepIndex++;let e=this.stage.flow[this.stepIndex];e&&(e.type===`wave`?this.spawnWave(e):e.type===`quiz`?this.startQuiz(e):e.type===`boss`&&this.spawnBoss(e))}nextStepType(){return this.stage.flow[this.stepIndex+1]?.type}startQuiz(e){this.phase=`quiz`,this.state=`quiz`,this.quiz.open({kind:e.kind,count:this.stage.learning[e.kind],session:this.session,onCorrect:e=>this.onQuizCorrect(e),onDone:()=>{this.state=`play`,this.phase=`between`,this.phaseTimer=Du.afterQuizDelay}})}onQuizCorrect(e){return this.stars+=ku.starsPerCorrect,this.hud.setStars(this.stars,!0),e===`recharge`?this.player.hearts>=Y.maxHearts?`Hearts are full!`:(this.player.hearts=Math.min(Y.maxHearts,this.player.hearts+ku.rechargeHearts),this.hud.setHearts(this.player.hearts,Y.maxHearts),`+${ku.rechargeHearts} heart`):(this.shields=Math.max(0,this.shields-1),`Shield broken!`)}spawnWave(e){this.waveNumber++,this.phase=`wave`,this.hud.setWave(`Wave ${this.waveNumber}/${this.waveTotal}`),this.hud.showBanner(`Wave ${this.waveNumber}!`);let t=this.player.position,n=Math.atan2(-t.z,-t.x);for(let r=0;r<e.count;r++){let i=n+(r-(e.count-1)/2)/e.count*Math.PI*1.4,a=new W(Math.cos(i)*Du.spawnRadius,0,Math.sin(i)*Du.spawnRadius);a.distanceTo(t)<5&&a.multiplyScalar(-1),this.enemies.push(new Fd(this,a,r+this.waveNumber,r*.25))}}spawnBoss(){this.phase=`boss`,this.hud.setWave(`Boss!`),this.hud.showBanner(this.shields>0?`${Ou.name} has ${this.shields} shield${this.shields>1?`s`:``}!`:`Here comes ${Ou.name}!`),this.hud.showBossBar(!0),this.hud.setBossShields(this.shields);let e=this.player.position,t=new W(-e.x,0,-e.z);t.length()<3&&t.set(0,0,-6),this.boss=new fd(this,t,{shields:this.shields,bonusHp:this.shields*ku.shieldBonusHp}),this.hud.setBossHp(this.boss.hp,this.boss.baseHp,this.boss.maxHp)}onPlayerDown(){this.endTimer=Y.downTime}onBossPopping(){this.player.controllable=!1,this.hud.showBanner(`Yay!`)}onBossDefeated(){this.phase=`done`,this.state=`clear`,this.player.cheer(),this.hud.showBossBar(!1),this.hud.showScreen(`clear`),this.hud.burstConfetti(),this.reviewTimer=ku.reviewDelay}showReview(){this.reviewTimer=-1,this.state=`review`;let e=this.session.stats;this.hud.showReview({stars:this.stars,asked:e.asked,firstTry:e.firstTry,practice:this.session.needsPractice(2)})}frame(){let e=performance.now(),t=Math.min((e-this.last)/1e3,.05);this.last=e,this.update(t),this.renderer.render(this.scene,this.camera)}update(e){let t=this.input;if(this.state===`title`){if(this.progressPanel.handleKeys(t),!this.progressPanel.open&&t.wasPressed(Su.start))return this.start()}else if(this.state===`quiz`)this.quiz.handleKeys(t);else if(t.wasPressed(Su.restart))return this.start();this.state===`clear`&&(this.reviewTimer-=e,(this.reviewTimer<=0||t.wasPressed(Su.start))&&this.showReview()),this.state===`play`?this.player.readInput(t):this.player.moveInput.set(0,0,0),t.endFrame();let n=this.state===`quiz`?0:e;if(n>0&&this.hitstopTimer>0&&(this.hitstopTimer-=e,n=0),this.state!==`title`){this.player.update(n);for(let e of this.enemies)e.update(n);this.boss&&this.boss.update(n);for(let e of this.hazards)e.update(n);this.hazards=this.hazards.filter(e=>!e.done),this.separate(),this.enemies=this.enemies.filter(e=>e.state!==`gone`||(this.world.remove(e.group),!1)),this.state===`play`&&this.updateFlow(n)}else this.player.update(e);this.updateFlowers(n),this.particles.update(n),this.numbers.update(e),this.camTarget.lerp(this.player.position,Iu(Cu.followSharpness,e));let r=this.shaker.update(e);this.camera.position.copy(this.camTarget).add(this.camOffset).add(r),jf.copy(this.camTarget).setY(Cu.lookHeight).add(r),this.camera.lookAt(jf)}updateFlow(e){if(this.endTimer>0){this.endTimer-=e,this.endTimer<=0&&(this.state=`over`,this.hud.showScreen(`over`));return}if(!(e<=0)){if(this.phase===`between`)this.phaseTimer-=e,this.phaseTimer<=0&&this.advance();else if(this.phase===`wave`&&this.enemies.length===0){this.phase=`between`;let e=this.nextStepType();this.phaseTimer=e===`boss`?Du.bossDelay:e===`quiz`?Du.quizDelay:Du.betweenDelay,this.hud.showBanner(e===`boss`?`Great job!`:`Nice!`)}}}separate(){let e=this.enemies.filter(e=>e.targetable);for(let t=0;t<e.length;t++){let n=e[t];for(let r=t+1;r<e.length;r++){let t=e[r],i=t.position.x-n.position.x,a=t.position.z-n.position.z,o=Math.hypot(i,a),s=n.radius+t.radius;if(o>1e-4&&o<s){let e=(s-o)/2;n.position.x-=i/o*e,n.position.z-=a/o*e,t.position.x+=i/o*e,t.position.z+=a/o*e}}}let t=this.player;for(let n of e){if(n.state===`lunge`)continue;let e=n.position.x-t.position.x,r=n.position.z-t.position.z,i=Math.hypot(e,r),a=n.radius+t.radius;i>1e-4&&i<a&&(n.position.x+=e/i*(a-i),n.position.z+=r/i*(a-i))}if(this.boss&&this.boss.targetable){let e=this.boss,n=t.position.x-e.position.x,r=t.position.z-e.position.z,i=Math.hypot(n,r),a=e.radius*.8+t.radius;i>1e-4&&i<a&&(t.position.x+=n/i*(a-i),t.position.z+=r/i*(a-i))}}updateFlowers(e){for(let t of this.flowers){if(t.t>=.6)continue;t.t+=e;let n=Pu(t.t/.6,0,1);t.root.scale.setScalar(Math.max(1e-4,zu(n)*t.size))}}}(document.getElementById(`game`));